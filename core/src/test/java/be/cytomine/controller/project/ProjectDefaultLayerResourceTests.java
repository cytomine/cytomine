...
public class ProjectDefaultLayerResourceTests {
    ...
    public void list_all_project_default_layers() throws Exception {
        ...
        restProjectDefaultLayerControllerMockMvc.perform(get("/api/project/{id}/defaultlayer" +
                ".json", projectDefaultLayer.getProject().getId()))
    ...
    public void get_a_projectDefaultLayer() throws Exception {
        ...
        restProjectDefaultLayerControllerMockMvc.perform(get("/api/project/{project}/defaultlayer" +
                    "/{id}.json",
    ...
    public void add_valid_projectDefaultLayer() throws Exception {
        ProjectDefaultLayer projectDefaultLayer =
            builder.given_a_not_persisted_project_default_layer();
        restProjectDefaultLayerControllerMockMvc.perform(post("/api/project/{id}/defaultlayer" +
                ".json", projectDefaultLayer.getProject().getId())
    ...
    public void edit_valid_projectDefaultLayer() throws Exception {
        ProjectDefaultLayer projectDefaultLayer = builder.given_a_project_default_layer();
        restProjectDefaultLayerControllerMockMvc.perform(put("/api/project/{project}/defaultlayer" +
                    "/{id}.json",
                projectDefaultLayer.getProject().getId(), projectDefaultLayer.getId())
                .contentType(MediaType.APPLICATION_JSON)
            ...
            .andExpect(jsonPath("$.callback").exists())
            .andExpect(jsonPath("$.callback.method").value("be.cytomine" +
                ".EditProjectDefaultLayerCommand"))
            .andExpect(jsonPath("$.message").exists())
            .andExpect(jsonPath("$.command").exists())
            .andExpect(jsonPath("$.projectdefaultlayer.id").exists())
    ...
    public void delete_projectDefaultLayer() throws Exception {
        ProjectDefaultLayer projectDefaultLayer = builder.given_a_project_default_layer();
        restProjectDefaultLayerControllerMockMvc.perform(delete("/api/project/{project" +
                    "}/defaultlayer/{id}.json",
                projectDefaultLayer.getProject().getId(), projectDefaultLayer.getId())
                .contentType(MediaType.APPLICATION_JSON)
                .content(projectDefaultLayer.toJSON()))
            .andExpect(status().isOk())
            ...
            .andExpect(jsonPath("$.callback.method").value("be.cytomine" +
                ".DeleteProjectDefaultLayerCommand"))
            .andExpect(jsonPath("$.message").exists())
            .andExpect(jsonPath("$.command").exists());
    }
