...
public class SimplifyGeometryServiceTests {
    ...
    public static int getPointMultiplyByGeometriesOrInteriorRings(Geometry geometry,
                                                                  long numberOfPoints) {
        int result = 0;
    ...
    public void simplify_big_annotation() throws ParseException {
        ...
        result = simplifyGeometryService.simplifyPolygon(annotation.getLocation(), minPoint,
            maxPoint);
    ...
    public void simplify_annotation_with_rate() throws ParseException {
        ...
        Geometry expected = new WKTReader().read("POLYGON ((120 120, 140 199, 160 200, 180 199, " +
            "220 120, 120 120))").norm();
        Double geometryCompression = 10.0;

        String location = "POLYGON ((120 120, 121 121, 122 122, 220 120, 180 199, 160 200, 140 " +
            "199, 120 120))";

        SimplifiedAnnotation simplifiedAnnotation =
            simplifyGeometryService.simplifyPolygon(location, geometryCompression);
