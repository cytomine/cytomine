...
public class RestStatsController extends RestCytomineController {
    ...
    public ResponseEntity<String> statAnnotationEvolution(
        ...
        return responseSuccess(statsService.statAnnotationEvolution(project, term, daysRange,
            startDate, endDate, reverseOrder, accumulate));
    }
    ...
    public ResponseEntity<String> statReviewedAnnotationEvolution(
        ...
        return responseSuccess(statsService.statReviewedAnnotationEvolution(project, term,
            daysRange, startDate, endDate, reverseOrder, accumulate));
    }
    ...
    public ResponseEntity<String> totalDomains(
        ...
        try {
            return responseSuccess(JsonObject.of("total",
                statsService.total(Class.forName(domain))));
    ...
    public ResponseEntity<String> statConnectionsEvolution(
        ...
        return responseSuccess(statsService.statConnectionsEvolution(project, daysRange,
            startDate, endDate, accumulate));
    }
    ...
    public ResponseEntity<String> statImageConsultationsEvolution(
        ...
        return responseSuccess(statsService.statImageConsultationsEvolution(project, daysRange,
            startDate, endDate, accumulate));
    }
    ...
    public ResponseEntity<String> statAnnotationActionsEvolution(
        ...
        return responseSuccess(statsService.statAnnotationActionsEvolution(project, daysRange,
            startDate, endDate, accumulate, type));
    }
