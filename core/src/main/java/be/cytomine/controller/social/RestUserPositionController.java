...
public class RestUserPositionController extends RestCytomineController {
    ...
    public ResponseEntity<String> add(
        ...
        Point topLeft = new Point(
            ...
            json.getJSONAttrDouble("topLeftY", 0d)
        );
        Point topRight = new Point(
            json.getJSONAttrDouble("topRightX", 0d),
            json.getJSONAttrDouble("topRightY", 0d)
        );
        Point bottomRight = new Point(
            json.getJSONAttrDouble("bottomRightX", 0d),
            json.getJSONAttrDouble("bottomRightY", 0d)
        );
        Point bottomLeft = new Point(
            json.getJSONAttrDouble("bottomLeftX", 0d),
    ...
    public ResponseEntity<String> list(
        ...
        if (showDetails) {
            return responseSuccess(userPositionService.list(
                imageInstance, user, sliceInstance, afterThan, beforeThan, max.intValue(), offset.intValue()
            ));
        } else {
            return responseSuccess(userPositionService.summarize(
                imageInstance, user, sliceInstance, afterThan, beforeThan
            ));
        }
    }
    ...
    public ResponseEntity<String> listOnlineUsersByImage(
        ...
        return responseSuccess(
            JsonObject.of("users", userPositionService.listOnlineUsersByImage(imageInstance, sliceInstance, broadcast))
        );
    }
