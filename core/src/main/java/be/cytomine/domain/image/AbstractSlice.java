...
public class AbstractSlice extends CytomineDomain {
    ...
    public CytomineDomain buildDomainFromJson(JsonObject json, EntityManager entityManager) {
        ...
        abstractSlice.uploadedFile = (UploadedFile) json.getJSONAttrDomain(entityManager,
            "uploadedFile", new UploadedFile(), false);
        abstractSlice.image = (AbstractImage) json.getJSONAttrDomain(entityManager, "image",
            new AbstractImage(), true);
        abstractSlice.mime = (Mime) json.getJSONAttrDomain(entityManager, "mime", new Mime(),
