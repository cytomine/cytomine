...
public class ImageGroupResourceTests {
    ...
    public void list_imagegroup_by_project() throws Exception {
        ...
        restImageGroupControllerMockMvc.perform(get("/api/project/{id}/imagegroup.json",
    ...
    public void get_an_imagegroup() throws Exception {
        ImageGroup imageGroup = builder.given_an_imagegroup();
        restImageGroupControllerMockMvc.perform(get("/api/imagegroup/{id}.json",
                imageGroup.getId()))
            .andExpect(status().isOk())
    ...
    public void delete_imagegroup() throws Exception {
        ImageGroup imageGroup = builder.given_an_imagegroup();
        restImageGroupControllerMockMvc.perform(delete("/api/imagegroup/{id}.json",
                imageGroup.getId()))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.printMessage").value(true))
            .andExpect(jsonPath("$.callback").exists())
