...
@Repository
public interface NestedImageInstanceRepository extends JpaRepository<NestedImageInstance, Long>,
    JpaSpecificationExecutor<NestedImageInstance> {
    ...
    Optional<NestedImageInstance> findByBaseImageAndParentAndProject(AbstractImage baseImage,
