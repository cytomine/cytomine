...
public class ResponseService {
    ...
    public CommandResponse createResponseMessage(CytomineDomain object,
                                                 List<Object> messageParams, boolean printMessage
        , String commandType) {
     ...
     *
     * @param object                   Object updated (add/edit/delete) by command  (e.g.
     *                                 annotation x)
     * @param messageParams            Params for i18n message (e.g. annotation id, annotation
     *                                 image id)
     * @param printMessage             Flag for client, indicate if client must print or not a
     *                                 confirmation message
     * @param commandType              Command type: add, edit or delete
     * @param additionalCallbackParams (optional): call back to append in response for client (e
     *                                 .g. image id as callback, to refresh image view in web UI
     *                                 client)
     * @return Response stucture
     */
    public CommandResponse createResponseMessage(CytomineDomain object,
                                                 List<Object> messageParams, boolean printMessage
        , String commandType, Map<String, Object> additionalCallbackParams) {
        ...
        params.put(objectName.toLowerCase(), JsonObject.toMap(object.toJSON()));     //Project
        // .getDataFromDomain(object)
    ...
    public Map<String, Object> createResponseData(Boolean success, String messageKey,
