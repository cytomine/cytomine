...
public class ProjectDefaultLayerServiceTests {
    ...
    void list_all_projectDefaultLayer_by_project_with_success() {
        ProjectDefaultLayer projectDefaultLayer = builder.given_a_project_default_layer();
        ProjectDefaultLayer projectDefaultLayerFromAnotherProject =
            builder.given_a_project_default_layer();
    ...
    void add_valid_projectDefaultLayer_with_success() {
        ...
        CommandResponse commandResponse =
            projectDefaultLayerService.add(projectDefaultLayer.toJsonObject());

        assertThat(commandResponse).isNotNull();
        assertThat(commandResponse.getStatus()).isEqualTo(200);
        assertThat(projectDefaultLayerService.find(commandResponse.getObject().getId())).isPresent();
        ProjectDefaultLayer created =
            projectDefaultLayerService.find(commandResponse.getObject().getId()).get();
    ...
    void add_projectDefaultLayer_with_bad_project() {
        ...
        Assertions.assertThrows(ObjectNotFoundException.class, () -> {
            projectDefaultLayerService.add(projectDefaultLayer.toJsonObject().withChange("project"
                , 0L));
        });
    }
    ...
    void add_projectDefaultLayer_with_bad_user() {
        ProjectDefaultLayer projectDefaultLayer =
            builder.given_a_not_persisted_project_default_layer();
        Assertions.assertThrows(ObjectNotFoundException.class, () -> {
            projectDefaultLayerService.add(projectDefaultLayer.toJsonObject().withChange("user",
                0L));
        });
    }
    ...
    void add_already_existing_projectDefaultLayer_fails() {
        ...
        Assertions.assertThrows(AlreadyExistException.class, () -> {
            projectDefaultLayerService.add(projectDefaultLayer.toJsonObject().withChange("id",
                null));
        });
    }
    ...
    void delete_projectDefaultLayer_with_success() {
        ...
        CommandResponse commandResponse = projectDefaultLayerService.delete(projectDefaultLayer,
            null, null, true);
