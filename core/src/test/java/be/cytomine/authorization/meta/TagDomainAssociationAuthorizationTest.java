...
public class TagDomainAssociationAuthorizationTest extends CRDAuthorizationTest {
    ...
    public void before() throws Exception {
        if (tagDomainAssociationForProject == null) {
            ...
            tagDomainAssociationForAnnotation =
                builder.given_a_tag_association(builder.given_a_tag(), annotationDomain);
            tagDomainAssociationForAbstractImage =
                builder.given_a_tag_association(builder.given_a_tag(), abstractImage);
    ...
    public void admin_can_list() {
        expectOK(() -> {
            tagDomainAssociationService.listAllByDomain(project);
        });
        expectOK(() -> {
            tagDomainAssociationService.listAllByTag(tagDomainAssociationForProject.getTag());
        });
    }
    ...
    public void user_can_list_with_filters() {
        ...
        assertThat(tagDomainAssociationService.list(new ArrayList<>()))
            .contains(tagDomainAssociationForProject, tagDomainAssociationForAnnotation,
                tagDomainAssociationForAbstractImage);
    }
