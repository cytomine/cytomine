...
public class ImageFilterProjectServiceTests {
    ...
    public void find_image_filter_project_with_success() {
        ...
        assertThat(imageFilterProjectService.find(imageFilterProject.getImageFilter(),
    ...
    public void list_all_image_filter_project_by_project() {
        ImageFilterProject imageFilterProject = builder.given_a_image_filter_project();
        ImageFilterProject imageFilterProjectForAnotherProject =
            builder.given_a_image_filter_project();
    ...
    public void add_image_filter_with_unexisting_project_return_error() {
        ...
        Assertions.assertThrows(ObjectNotFoundException.class, () -> {
            imageFilterProjectService.add(imageFilterProject.toJsonObject().withChange("project",
                0L));
        });
    }
    ...
    public void add_image_filter_with_unexisting_image_filter_return_error() {
        ...
        Assertions.assertThrows(ObjectNotFoundException.class, () -> {
            imageFilterProjectService.add(imageFilterProject.toJsonObject().withChange(
                "imageFilter", 0L));
        });
    }
    ...
    void delete_projectRepresentativeUser_with_success() {
        ImageFilterProject imageFilterProject = builder.given_a_image_filter_project();
        CommandResponse commandResponse = imageFilterProjectService.delete(imageFilterProject,
            null, null, true);

        assertThat(commandResponse).isNotNull();
        assertThat(commandResponse.getStatus()).isEqualTo(200);
        assertThat(imageFilterProjectService.find(imageFilterProject.getImageFilter(),
            imageFilterProject.getProject()).isEmpty());
    }
}
