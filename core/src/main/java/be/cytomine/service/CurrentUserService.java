...
public class CurrentUserService {
    ...
    public User getCurrentUser() {
        ...
        if (currentUser.isFullObjectProvided()) {
            ...
            user =
                userRepository.findByUsernameLikeIgnoreCase(currentUser.getUser().getUsername()).orElseThrow(() -> new ServerException("Cannot find current user with username " + currentUser.getUser().getUsername()));
        } else {
            throw new ObjectNotFoundException("User",
