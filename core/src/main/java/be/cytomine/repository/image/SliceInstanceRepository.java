 ...
 */
@Repository
public interface SliceInstanceRepository extends JpaRepository<SliceInstance, Long>,
    JpaSpecificationExecutor<SliceInstance> {

    Optional<SliceInstance> findByBaseSliceAndImage(AbstractSlice abstractSlice,
    ...
    @Query("SELECT si " +
        ...
        "   bs.zStack ASC, " +
        "   bs.channel ASC ")
    List<SliceInstance> listByImageInstanceOrderedByTZC(ImageInstance imageInstance,
                                                        Integer baseSliceTime,
                                                        Integer baseSliceZStack,
                                                        Integer baseSliceChannel,
                                                        Long userAnnotationSliceId);
