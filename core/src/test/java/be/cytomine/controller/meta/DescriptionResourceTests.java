...
public class DescriptionResourceTests {
    ...
    public void get_an_description() throws Exception {
        Description description = builder.given_a_description(builder.given_a_project());
        restDescriptionControllerMockMvc.perform(get("/api/domain/{domainClassName}/{domainIdent" +
                    "}/description.json", description.getDomainClassName(),
    ...
    public void get_an_description_does_not_exists() throws Exception {
        Description description =
            builder.given_a_not_persisted_description(builder.given_a_project());
        restDescriptionControllerMockMvc.perform(get("/api/domain/{domainClassName}/{domainIdent" +
                    "}/description.json", description.getDomainClassName(),
                description.getDomainIdent()))
    ...
    public void add_valid_description() throws Exception {
        Description description =
            builder.given_a_not_persisted_description(builder.given_a_project());
        restDescriptionControllerMockMvc.perform(post("/api/domain/{domainClassName}/{domainIdent" +
                    "}/description.json", description.getDomainClassName(),
                description.getDomainIdent())
    ...
    public void edit_valid_description() throws Exception {
        ...
        restDescriptionControllerMockMvc.perform(put("/api/domain/{domainClassName}/{domainIdent" +
                    "}/description.json", description.getDomainClassName(),
                description.getDomainIdent())
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void delete_description() throws Exception {
        Description description =
            builder.given_a_not_persisted_description(builder.given_a_project());
        builder.persistAndReturn(description);
        restDescriptionControllerMockMvc.perform(delete("/api/domain/{domainClassName" +
                    "}/{domainIdent}/description.json", description.getDomainClassName(),
                description.getDomainIdent())
                .contentType(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk());
    }
