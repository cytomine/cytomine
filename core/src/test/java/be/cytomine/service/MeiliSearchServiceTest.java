...
public class MeiliSearchServiceTest {
    ...
    private Page<StorageResponse> aPageOfStorages(Long... ids) {
    ...
    public void searchWindowShouldResolveUserStoragesInOneCall() {
        when(storageHttpContract.getAll(eq(7L), any())).thenReturn(aPageOfStorages(7L, 8L));
    ...
    public void searchWindowShouldScopeToImpossibleStorageWhenUserHasNoStorage() {
        when(storageHttpContract.getAll(eq(7L), any())).thenReturn(aPageOfStorages());
