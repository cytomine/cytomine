...
public class RestAbstractImageController extends RestCytomineController {
    ...
    public ResponseEntity<String> list(
        ...
        Project project = idProject == null ? null :
            projectService.find(idProject).orElseThrow(() -> new ObjectNotFoundException("Project"
                , idProject));
        return responseSuccess(abstractImageService.list(project, retrieveSearchParameters(),
            retrievePageable()));
    }
    ...
    @RequestMapping(value = "/abstractimage/{id}/thumb.{format}", method = {RequestMethod.GET,
        RequestMethod.POST})
    public ResponseEntity<byte[]> thumb(
        ...
        return imageServerService.thumb(sliceCoordinatesService.getReferenceSlice(abstractImage),
            thumbParameter, etag, proxy);
    }


    @RequestMapping(value = "/abstractimage/{id}/preview.{format}", method = {RequestMethod.GET,
        RequestMethod.POST})
    ...
    @RequestMapping(value = "/abstractimage/{id}/associated/{label}.{format}", method =
    ...
    @RequestMapping(value = "/abstractimage/{id}/crop.{format}", method = {RequestMethod.GET,
        RequestMethod.POST})
    public ResponseEntity<byte[]> crop(
        ...
        String etag = getRequestETag();
        return imageServerService.crop(sliceCoordinatesService.getReferenceSlice(abstractImage),
            cropParameter, etag, proxy);
    }

    @RequestMapping(value = "/abstractimage/{id}/window-{x}-{y}-{w}-{h}.{format}", method =
        {RequestMethod.GET, RequestMethod.POST})
    public ResponseEntity<byte[]> window(
        ...
        AbstractImage abstractImage = abstractImageService.find(id)
            .orElseThrow(() -> new ObjectNotFoundException("AbstractImage", id));
        String etag = getRequestETag();
        return imageServerService.window(sliceCoordinatesService.getReferenceSlice(abstractImage)
            , windowParameter, etag, proxy);
    }

    @RequestMapping(value = "/abstractimage/{id}/camera-{x}-{y}-{w}-{h}.{format}", method =
        {RequestMethod.GET, RequestMethod.POST})
    ...
    public ResponseEntity<String> extractUseful(@PathVariable Long id) throws IOException,
