...
public class RestUserController extends RestCytomineController {
    ...
    public ResponseEntity<String> showCreatorByProject(
        ...
        Project project = projectService.find(id)
            .orElseThrow(() -> new ObjectNotFoundException("Project", id));
        return responseSuccess(List.of(userService.findCreator(project)
            .orElseThrow(() -> new ObjectNotFoundException("Project", "CREATOR")))
        );
    }
    ...
    public ResponseEntity<String> regenerateCurrentUserKeys() {
        User user = userService.regenerateKeys(currentUserService.getCurrentUserOld());
        return responseSuccess(JsonObject.of(
    ...
    public ResponseEntity<String> getCurrentUser(
        ...
        return responseSuccess(currentUserService.getCurrentUserOld());
    }

    @GetMapping("/project/{id}/user.json")
    public ResponseEntity<String> showByProject(
        @PathVariable Long id,
        @RequestParam(defaultValue = "false") Boolean withLastImage,
        @RequestParam(defaultValue = "false") Boolean withLastConsultation,
        @RequestParam(defaultValue = "false") Boolean withNumberConsultations,
        @RequestParam(defaultValue = "created") String sortColumn,
        ...
        return responseSuccess(
            userService.listUsersExtendedByProject(
                project, userSearchExtension, retrieveSearchParameters(), sortColumn, sortDirection, max, offset
            ),
            isFilterRequired()
        );
    }
    ...
    public ResponseEntity<String> addUsersToProject(
        @PathVariable("project") Long projectId,
    ...
    public ResponseEntity<String> deleteUsersFromProject(
        @PathVariable("project") Long projectId,
        @RequestParam("users") String userIds
    ) {
        log.debug("REST request to add Users {} to project {}", userIds, projectId);
    ...
    public ResponseEntity<String> addUserAdminToProject(
        @PathVariable("project") Long projectId,
        @PathVariable("user") Long userId
    ) {
        log.debug("REST request to add User {} to project {}", userId, projectId);
    ...
    public ResponseEntity<String> deleteUserAdminFromProject(
        @PathVariable("project") Long projectId,
        @PathVariable("user") Long userId
    ) {
        log.debug("REST request to remove User {} from project {}", userId, projectId);
