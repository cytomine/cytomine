...
public class ImageFilterProject extends CytomineDomain {
    ...
    public CytomineDomain buildDomainFromJson(JsonObject json, EntityManager entityManager) {
        ...
        try {
            ...
            processingServer.imageFilter = (ImageFilter) json.getJSONAttrDomain(entityManager,
                "imageFilter", new ImageFilter(), false);
            processingServer.project = (Project) json.getJSONAttrDomain(entityManager, "project",
                new Project(), false);
        } catch (Exception e) {
            processingServer.imageFilter =
                (ImageFilter) json.getJSONObject("imageFilter").getJSONAttrDomain(entityManager,
                    "id", new ImageFilter(), false);
            processingServer.project =
                (Project) json.getJSONObject("project").getJSONAttrDomain(entityManager, "id",
                    new Project(), false);
        }
