...
@Repository
public interface ImageGroupImageInstanceRepository extends JpaRepository<ImageGroupImageInstance,
    Long>, JpaSpecificationExecutor<ImageGroupImageInstance> {
    ...
    Optional<ImageGroupImageInstance> findByGroupAndImage(ImageGroup group,
