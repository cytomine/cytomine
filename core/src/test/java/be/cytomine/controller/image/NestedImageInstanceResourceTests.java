...
public class NestedImageInstanceResourceTests {
    ...
    public void list_nested_image_instance_by_image_instance() throws Exception {
        ...
        restNestedImageInstanceControllerMockMvc.perform(get("/api/imageinstance/{imageInstanceId" +
                "}/nested.json", nestedImageInstance.getParent().getId()))
    ...
    public void get_an_nested_image_instance() throws Exception {
        ...
        restNestedImageInstanceControllerMockMvc.perform(get("/api/imageinstance/{imageInstanceId" +
                "}/nested/{id}.json", image.getParent().getId(), image.getId()))
            .andExpect(status().isOk())
            ...
            .andExpect(jsonPath("$.baseImage").hasJsonPath()); // expect to have field from
        // imageinstance
    }
    ...
    public void add_valid_nested_image_instance() throws Exception {
        ...
        restNestedImageInstanceControllerMockMvc.perform(post("/api/imageinstance" +
                "/{imageInstanceId}/nested.json", builder.given_an_image_instance().getId())
    ...
    public void edit_valid_nested_image_instance() throws Exception {
        ...
        restNestedImageInstanceControllerMockMvc.perform(put("/api/imageinstance/{imageInstanceId" +
                    "}/nested/{id}.json", nestedImageInstance.getParent().getId(),
            ...
            .andExpect(jsonPath("$.callback.method").value("be.cytomine" +
                ".EditNestedImageInstanceCommand"))
            .andExpect(jsonPath("$.message").exists())
            .andExpect(jsonPath("$.command").exists())
            .andExpect(jsonPath("$.nestedimageinstance.id").exists())
    ...
    public void delete_nested_image_instance() throws Exception {
        NestedImageInstance nestedImageInstance = builder.given_a_nested_image_instance();
        restNestedImageInstanceControllerMockMvc.perform(delete("/api/imageinstance" +
                    "/{imageInstanceId}/nested/{id}.json", nestedImageInstance.getParent().getId(),
                nestedImageInstance.getId()))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.printMessage").value(true))
            .andExpect(jsonPath("$.callback").exists())
            .andExpect(jsonPath("$.callback.nestedimageinstanceID").exists())
            .andExpect(jsonPath("$.callback.method").value("be.cytomine" +
                ".DeleteNestedImageInstanceCommand"))
            .andExpect(jsonPath("$.message").exists())
            .andExpect(jsonPath("$.command").exists())
            .andExpect(jsonPath("$.nestedimageinstance.id").exists());
