...
public class ProjectRepresentativeUserAuthorizationTest extends CRDAuthorizationTest {
    ...
    protected void when_i_delete_domain() {
        ...
        builder.addUserToProject(projectRepresentativeUser.getProject(), user.getUsername());
        ProjectRepresentativeUser projectRepresentativeUserToDelete =
            builder.given_a_not_persisted_project_representative_user(projectRepresentativeUser.getProject(),
                user);
        builder.persistAndReturn(projectRepresentativeUserToDelete);
        projectRepresentativeUserService.delete(projectRepresentativeUserToDelete, null, null,
            true);
    }
