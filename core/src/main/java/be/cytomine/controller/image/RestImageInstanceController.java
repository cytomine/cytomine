...
public class RestImageInstanceController extends RestCytomineController {
    ...
    public ResponseEntity<String> listByUser(
        ...
        return responseSuccess(imageInstanceService.list(user, retrieveSearchParameters(),
            requestParams.getSort(), requestParams.getOrder(), requestParams.getOffset(),
    ...
    public ResponseEntity<String> listByProject(
        ...
        RequestParams requestParams = retrievePageableParameters();
        if (light) {
            return responseSuccess(imageInstanceService.listLight(project),
                securityACLService.isFilterRequired(project));
        } else if (tree) {
            return responseSuccess(imageInstanceService.listTree(project,
                    requestParams.getOffset(), requestParams.getMax()),
                securityACLService.isFilterRequired(project));
            ...
            return responseSuccess(imageInstanceService.listExtended(project,
                    imageSearchExtension, retrieveSearchParameters(), requestParams.getSort(),
                    requestParams.getOrder(), requestParams.getOffset(), requestParams.getMax()),
                securityACLService.isFilterRequired(project));
        } else {
    ...
    @RequestMapping(value = "/imageinstance/{id}/thumb.{format}", method = {RequestMethod.GET,
        RequestMethod.POST})
    ...
    @RequestMapping(value = "/imageinstance/{id}/preview.{format}", method = {RequestMethod.GET,
        RequestMethod.POST})
    public ResponseEntity<byte[]> preview(
        ...
        previewParameter.setBits(bits != null && !bits.equals("max") ? Integer.parseInt(bits) :
            null);
    ...
    public ResponseEntity<String> histogram(
        ...
        ImageInstance imageInstance = imageInstanceService.find(id)
            .orElseThrow(() -> new ObjectNotFoundException("ImageInstance", id));
        return responseSuccess(imageServerService.imageHistogram(imageInstance.getBaseImage(),
            nBins));
    }
    ...
    public ResponseEntity<String> channelHistograms(
        ...
        ImageInstance imageInstance = imageInstanceService.find(id)
            .orElseThrow(() -> new ObjectNotFoundException("ImageInstance", id));
        return responseSuccess(imageServerService.channelHistograms(imageInstance.getBaseImage(),
            nBins));
    }
    ...
    @RequestMapping(value = "/imageinstance/{id}/associated/{label}.{format}", method =
    ...
    public ResponseEntity<byte[]> label(
        ...
        if (securityACLService.isFilterRequired(imageInstance.getProject())) {
            throw new ForbiddenException("You don't have the right to read or modify this " +
                "resource! " + imageInstance.getClass().toString() + " " + id);
        }
    ...
    @RequestMapping(value = "/imageinstance/{id}/crop.{format}", method = {RequestMethod.GET,
        RequestMethod.POST})
...
//        cropParameter.setBoundaries(boundaries);
    ...
    @RequestMapping(value = "/imageinstance/{id}/window-{x}-{y}-{w}-{h}.{format}", method =
        {RequestMethod.GET, RequestMethod.POST})
    ...
    @RequestMapping(value = "/imageinstance/{id}/camera-{x}-{y}-{w}-{h}.{format}", method =
        {RequestMethod.GET, RequestMethod.POST})
