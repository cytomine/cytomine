        ...
        http
            ...
            .authorizeHttpRequests((authorizeHttpRequests) ->
                    authorizeHttpRequests
                        ...
                        .requestMatchers(HttpMethod.GET, "/server/ping").permitAll() // TODO 2024
                        // .2 -
                        // LAST CONNECTION (IN A PROJECT)
                        .requestMatchers(HttpMethod.GET, "/server/ping.json").permitAll() // TODO
                        // 2024.2 - LAST CONNECTION (IN A PROJECT)
                        .requestMatchers(HttpMethod.POST, "/server/ping").permitAll() // TODO 2024.2
                        // - LAST CONNECTION (IN A PROJECT)
                        .requestMatchers(HttpMethod.POST, "/server/ping.json").permitAll() // TODO
                        // 2024.2 - LAST CONNECTION (IN A PROJECT)
                        .requestMatchers(new AntPathRequestMatcher("/**")).permitAll() // TODO IAM:
                // remove ?
            );
