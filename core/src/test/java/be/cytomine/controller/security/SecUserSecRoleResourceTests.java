...
public class SecUserSecRoleResourceTests {
    ...
    public void list_roles() throws Exception {
        ...
        restSecUserSecRoleControllerMockMvc.perform(get("/api/user/{user}/role.json",
    ...
    public void add_valid_role() throws Exception {
        ...
        SecUserSecRole secSecUserSecRole = builder.given_a_not_persisted_user_role(user,
    ...
    public void delete_user_role() throws Exception {
        ...
        restSecUserSecRoleControllerMockMvc.perform(delete("/api/user/{user}/role/{role}.json",
                user.getId(), secSecUserSecRole.getSecRole().getId())
                .contentType(MediaType.APPLICATION_JSON)
                .content(secSecUserSecRole.toJSON()))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.printMessage").value(true))
    ...
    public void delete_parent_relation_term() throws Exception {
        ...
        restSecUserSecRoleControllerMockMvc.perform(delete("/api/relation/parent/term1/{idTerm1" +
    ...
    public void define() throws Exception {
        ...
        restSecUserSecRoleControllerMockMvc.perform(put("/api/user/{user}/role/{role}/define" +
                ".json", user.getId(), secRoleRepository.getAdmin().getId())
                .contentType(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk());
