...
public class ImagePropertiesService {
    ...
    private static Map<String, Integer> PIXEL_TYPE = Map.of("uint8", 8, "int8", 8, "uint16", 16,
        "int16", 16);
    ...
    public void extractUseful(AbstractImage image, boolean deep) throws IOException,
        IllegalAccessException {

        try {
            Map<String, Object> properties = imageServerService.properties(image);
            Map<String, Object> imageProperties = (Map<String, Object>) properties.getOrDefault(
                "image", Map.of());
            ...
            Map<String, Object> instrument = ((Map<String, Object>) properties.getOrDefault(
                "instrument", Map.of()));
            Map<String, Object> objective = ((Map<String, Object>) instrument.getOrDefault(
                "objective", Map.of()));
            ...
            if (deep) {
                List<Map<String, Object>> channels =
                    (List<Map<String, Object>>) properties.getOrDefault("channels", List.of());
                for (int i = 0; i < image.getApparentChannels(); i += image.getSamplePerPixel()) {
                    ...
                    int index = Math.floorDiv((Integer) channel.get("index"),
                        image.getSamplePerPixel());
                    ...
                    List<AbstractSlice> slices =
                        abstractSliceRepository.findAllByImageAndChannel(image, index)
                            .stream().filter(x -> Objects.equals(x.getChannel(),
                                (Integer) channel.get("index"))).toList();
    ...
    public void regenerate(AbstractImage image, boolean deep) throws IOException,
        IllegalAccessException {
