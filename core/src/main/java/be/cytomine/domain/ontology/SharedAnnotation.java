...
public class SharedAnnotation extends CytomineDomain implements Serializable {
    ...
    public static JsonObject getDataFromDomain(CytomineDomain domain) {
        ...
        returnArray.put("sender", (sharedAnnotation.getSender() != null ?
            sharedAnnotation.getSender().getId() : null));
        returnArray.put("senderName", (sharedAnnotation.getSender() != null ?
            sharedAnnotation.getSender().toString() : null));

        returnArray.put("receivers",
    ...
    public CytomineDomain buildDomainFromJson(JsonObject json, EntityManager entityManager) {
        ...
        sharedAnnotation.sender = (User) json.getJSONAttrDomain(entityManager, "sender",
            new User(), false);
