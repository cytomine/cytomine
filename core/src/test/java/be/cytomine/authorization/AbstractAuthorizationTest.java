...
public abstract class AbstractAuthorizationTest {
    ...
    protected void initACL(CytomineDomain container) {
        ...
        //get acl object id
        Long aclObjectIdentity = permissionService.getAclObjectIdentity(container, aclClassId,
            sidCurrentUser);

        permissionService.addPermissionOptimised(aclObjectIdentity, USER_ACL_READ,
            BasePermission.READ, 100);
        permissionService.addPermissionOptimised(aclObjectIdentity, USER_ACL_WRITE,
            BasePermission.WRITE, 101);
        permissionService.addPermissionOptimised(aclObjectIdentity, USER_ACL_CREATE,
            BasePermission.CREATE, 102);
        permissionService.addPermissionOptimised(aclObjectIdentity, USER_ACL_DELETE,
            BasePermission.DELETE, 103);
        permissionService.addPermissionOptimised(aclObjectIdentity, USER_ACL_ADMIN,
            BasePermission.ADMINISTRATION, 104);
        permissionService.addPermissionOptimised(aclObjectIdentity, GUEST, BasePermission.READ,
            105);
        permissionService.addPermissionOptimised(aclObjectIdentity, CREATOR,
            BasePermission.CREATE, 106);
    }
