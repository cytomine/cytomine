...
public class RelationTermServiceTests {
    ...
    void find_relation_term_with_success() {
        ...
        Optional<RelationTerm> result = relationTermService.find(relationTerm.getRelation(),
            relationTerm.getTerm1(), relationTerm.getTerm2());
    ...
    void find_unexisting_relation_term_return_empty() {
        assertThat(relationTermService.find(builder.given_a_relation(), builder.given_a_term(),
            builder.given_a_term())).isEmpty();
    }
    ...
    void list_relation_by_term() {
        ...
        assertThat(relationTermService.list(parent)).asList().containsExactlyInAnyOrder(parent1,
            parent2);
    ...
    void undo_redo_term_creation_with_success() {
        ...
        Term child1 = builder.given_a_term(parent.getOntology());
        RelationTerm parentRelationTerm =
            builder.given_a_not_persisted_relation_term(builder.given_a_relation(), parent, child1);
    ...
    void delete_relation_term_with_success() {
        ...
        CommandResponse commandResponse = relationTermService.delete(parentRelationTerm, null,
            null, true);
