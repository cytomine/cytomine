...
public class ImageInstance extends CytomineDomain {
    ...
    public static JsonObject getDataFromDomain(CytomineDomain domain) {
        ...
        returnArray.put("filename",
            Optional.ofNullable(imageInstance.getBaseImage()).map(AbstractImage::getFilename).orElse(null));
        returnArray.put("blindedName", imageInstance.getBlindedName());
        returnArray.put("path",
            Optional.ofNullable(imageInstance.getBaseImage()).map(AbstractImage::getPath).orElse(null));
        returnArray.put("contentType",
            Optional.ofNullable(imageInstance.getBaseImage()).map(AbstractImage::getUploadedFile).map(UploadedFile::getContentType).orElse(null));

        returnArray.put("width",
            Optional.ofNullable(imageInstance.getBaseImage()).map(AbstractImage::getWidth).orElse(null));
        returnArray.put("height",
            Optional.ofNullable(imageInstance.getBaseImage()).map(AbstractImage::getHeight).orElse(null));
        returnArray.put("depth",
            Optional.ofNullable(imageInstance.getBaseImage()).map(AbstractImage::getDepth).orElse(null));  // /!!\ Breaking API : image?.baseImage?.getZoomLevels()?.max
        returnArray.put("duration",
            Optional.ofNullable(imageInstance.getBaseImage()).map(AbstractImage::getDuration).orElse(null));
        returnArray.put("channels",
            Optional.ofNullable(imageInstance.getBaseImage()).map(AbstractImage::getChannels).orElse(null));
        returnArray.put("extrinsicChannels",
        ...
        returnArray.put("zoom",
            Optional.ofNullable(imageInstance.getBaseImage()).map(AbstractImage::getZoomLevels).orElse(null));

        returnArray.put("tileSize",
            Optional.ofNullable(imageInstance.getBaseImage()).map(AbstractImage::getTileSize).orElse(null));
        returnArray.put("isVirtual",
            Optional.ofNullable(imageInstance.getBaseImage()).map(AbstractImage::isVirtual).orElse(null));

        returnArray.put("magnification", imageInstance.getMagnification());
        returnArray.put("bitPerSample",
            Optional.ofNullable(imageInstance.getBaseImage()).map(AbstractImage::getBitPerSample).orElse(null));
        returnArray.put("samplePerPixel",
            Optional.ofNullable(imageInstance.getBaseImage()).map(AbstractImage::getSamplePerPixel).orElse(null));

        returnArray.put("colorspace",
            Optional.ofNullable(imageInstance.getBaseImage()).map(AbstractImage::getColorspace).orElse(null));


        returnArray.put("reviewStart",
            Optional.ofNullable(imageInstance.getReviewStart()).map(x -> String.valueOf(x.getTime())).orElse(null));
        returnArray.put("reviewStop",
            Optional.ofNullable(imageInstance.getReviewStop()).map(x -> String.valueOf(x.getTime())).orElse(null));
        returnArray.put("reviewUser",
            Optional.ofNullable(imageInstance.getReviewUser()).map(User::getId).orElse(null));
        ...
        returnArray.put("thumb", UrlApi.getImageInstanceThumbUrlWithMaxSize(imageInstance.id, 512
            , "png"));
        returnArray.put("preview", UrlApi.getImageInstanceThumbUrlWithMaxSize(imageInstance.id,
            1024, "png"));
        returnArray.put("macroURL", UrlApi.getAssociatedImage(imageInstance, "macro",
            Optional.ofNullable(imageInstance.getBaseImage()).map(AbstractImage::getUploadedFile).map(UploadedFile::getContentType).orElse(null), 512, "png"));
    ...
    public CytomineDomain buildDomainFromJson(ImageInstance imageInstance, JsonObject json,
        ...
        imageInstance.user = (User) json.getJSONAttrDomain(entityManager, "user", new User(),
            false);
        imageInstance.baseImage = (AbstractImage) json.getJSONAttrDomain(entityManager,
            "baseImage", new AbstractImage(), false);
        imageInstance.project = (Project) json.getJSONAttrDomain(entityManager, "project",
            new Project(), false);
        ...
        imageInstance.reviewUser = (User) json.getJSONAttrDomain(entityManager, "reviewUser",
            new User(), false);
