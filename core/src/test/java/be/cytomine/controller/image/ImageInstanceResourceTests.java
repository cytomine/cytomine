...
public class ImageInstanceResourceTests {
    ...
    public void get_image_instance_bounds() throws Exception {
        ...
        restImageInstanceControllerMockMvc.perform(get(
                "/api/project/{id}/bounds/imageinstance.json",
    ...
    public void list_image_instance_light() throws Exception {
        ...
        restImageInstanceControllerMockMvc.perform(get("/api/project/{id}/imageinstance.json", project1.getId())
            ...
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection[?(@.id==" + imageInProject1.getId() + ")]").exists())
            .andExpect(jsonPath("$.collection[?(@.id==" + imageInProject1.getId() + ")].instanceFilename").value(
                imageInProject1.getBlindInstanceFilename()))
            .andExpect(jsonPath("$.collection[?(@.id==" + imageInAnotherProject.getId() + ")]").doesNotExist());
    }
    ...
    public void list_image_instance_by_projects_blind_filenames() throws Exception {
        ...
        restImageInstanceControllerMockMvc.perform(get(
                "/api/project/{id}/imageinstance.json",
                image.getProject().getId()
            ))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection[?(@.id==" + image.getId() + ")]").exists())
    ...
    public void get_image_instance_thumb() throws Exception {
        ...
        MvcResult mvcResult = restImageInstanceControllerMockMvc.perform(get(
                "/api/imageinstance/{id}/thumb.png?maxSize=512&Authorization=Bearer " + getSignedNotExpiredJwt(),
                image.getId()
            ))
            .andExpect(status().isOk())
            .andReturn();
    ...
    public void get_image_instance_preview() throws Exception {
        ...
        MvcResult mvcResult = restImageInstanceControllerMockMvc.perform(get(
                "/api/imageinstance/{id}/preview.png?maxSize=1024",
                image.getId()
            ))
            .andExpect(status().isOk())
            .andReturn();
    ...
    public void get_image_instance_associeted_label_macro() throws Exception {
        ...
        MvcResult mvcResult = restImageInstanceControllerMockMvc.perform(get(
                "/api/imageinstance/{id}/associated/{label}.png",
                image.getId(),
                "macro"
            )
                .param("maxSize", "512"))
    ...
    public void get_image_instance_crop() throws Exception {
        ...
        MvcResult mvcResult = restImageInstanceControllerMockMvc.perform(get(
                "/api/imageinstance/{id}/crop.png?maxSize=512",
                image.getId()
            )
    ...
    public void get_image_instance_window() throws Exception {
        ...
        MvcResult mvcResult = restImageInstanceControllerMockMvc.perform(get(
                "/api/imageinstance/{id}/window-10-20-30-40.png",
                image.getId()
            ))
            .andExpect(status().isOk())
            .andReturn();
    ...
    public void download_image_instance() throws Exception {
        ...
        stubFor(get(urlEqualTo(IMS_API_BASE_PATH + "/image/" + URLEncoder.encode(
                ...
                image.getBaseImage().getOriginalFilename(),
                StandardCharsets.UTF_8
            )))
                .willReturn(
                    aResponse().withBody(mockResponse)
        ...
        MvcResult mvcResult = restImageInstanceControllerMockMvc.perform(get(
                "/api/imageinstance/{id}/download?Authorization=Bearer " + getSignedNotExpiredJwt(),
                image.getId()
            ))
    ...
    public void histograms() throws Exception {
        ...
        stubFor(get(urlEqualTo(IMS_API_BASE_PATH + "/image/" + URLEncoder.encode(
                image.getBaseImage().getPath(),
                StandardCharsets.UTF_8
            ).replace("%2F", "/") + "/histogram/per-image?n_bins=256"))
                .willReturn(
                    aResponse().withBody(
                        """
    ...
    public void histograms_bounds() throws Exception {
        ...
        stubFor(get(urlEqualTo(IMS_API_BASE_PATH + "/image/" + URLEncoder.encode(
                image.getBaseImage().getPath(),
                StandardCharsets.UTF_8
            ).replace("%2F", "/") + "/histogram/per-image/bounds?n_bins=256"))
                .willReturn(
                    aResponse().withBody(
                        """
    ...
    public void channel_histograms_bounds() throws Exception {
        ...
        stubFor(get(urlEqualTo(IMS_API_BASE_PATH + "/image/" + URLEncoder.encode(
                image.getBaseImage().getPath(),
                StandardCharsets.UTF_8
            ).replace("%2F", "/") + "/histogram/per-channels/bounds"))
                .willReturn(
                    aResponse().withBody(
                        """
                                {"items":[
        ...
        restImageInstanceControllerMockMvc.perform(get(
                "/api/imageinstance/{id}/channelhistogram/bounds.json",
                image.getId()
            ))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection", hasSize(equalTo(3))))
