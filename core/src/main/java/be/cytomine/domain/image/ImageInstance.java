    ...
    public static JsonObject getDataFromDomain(CytomineDomain domain) {
        ...
        returnArray.put(
            ...
            Optional.ofNullable(imageInstance.getBaseImage())
                .map(AbstractImage::getUploadedFile)
        ...
        returnArray.put(
            "depth",
            Optional.ofNullable(imageInstance.getBaseImage()).map(AbstractImage::getDepth).orElse(null)
        );  // /!!\ Breaking API : image?.baseImage?.getZoomLevels()?.max
        returnArray.put(
            "duration",
