...
public class ImageFilterProjectAuthorizationTest extends CRDAuthorizationTest {
    ...
    public void when_i_get_domain() {
        imageFilterProjectService.find(imageFilterProject.getImageFilter(),
    ...
    protected void when_i_add_domain() {
        imageFilterProjectService.add(
            builder.given_a_not_persisted_image_filter_project(builder.given_a_image_filter(),
                imageFilterProject.getProject()).toJsonObject()
        );
    }

    @Override
    protected void when_i_delete_domain() {
        ImageFilterProject imageFilterProjectThatMustBeDeleted =
            builder.given_a_not_persisted_image_filter_project(builder.given_a_image_filter(),
                imageFilterProject.getProject());
