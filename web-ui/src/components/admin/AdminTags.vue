  ...
  <div>
    ...
    <template v-else>
      ...
      <b-table
        ...
        @sort="onSort"
      >
        <b-table-column field="name" :label="$t('name')" sortable v-slot="{ row: tag }">
          {{ tag.name }}
        </b-table-column>

        <b-table-column field="creatorName" :label="$t('creator')" v-slot="{ row: tag }">
          {{ tag.creatorName }}
        </b-table-column>

        <b-table-column field="created" :label="$t('created')" sortable v-slot="{ row: tag }">
          {{ formatDate(tag.created) }}
        </b-table-column>

        <b-table-column label=" " centered v-slot="{ row: tag }">
          <div class="buttons">
