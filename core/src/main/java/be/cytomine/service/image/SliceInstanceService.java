...
public class SliceInstanceService extends ModelService {
    ...
    public Optional<SliceInstance> find(ImageInstance image, int c, int z, int t) {
        Optional<SliceInstance> optionalSliceInstance = sliceInstanceRepository.findByCZT(image,
            c, z, t);
    ...
    public void checkDoNotAlreadyExist(CytomineDomain domain) {
        ...
        Optional<SliceInstance> alreadyExist =
            sliceInstanceRepository.findByBaseSliceAndImage(sliceInstance.getBaseSlice(),
                sliceInstance.getImage());
        if (alreadyExist.isPresent() && (!Objects.equals(alreadyExist.get().getId(),
            domain.getId()))) {
    ...
    private void deleteDependentAnnotationTrack(SliceInstance slice, Transaction transaction,
                                                Task task) {
    ...
    private void deleteDependentAnnotationIndex(SliceInstance slice, Transaction transaction,
                                                Task task) {
