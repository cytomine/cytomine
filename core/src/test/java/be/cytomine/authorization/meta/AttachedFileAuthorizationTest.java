...
public class AttachedFileAuthorizationTest extends CRDAuthorizationTest {
    ...
    public void admin_can_list_by_domain() {
        expectOK(() -> {
            attachedFileService.findAllByDomain(attachedFile.getDomainClassName(),
    ...
    protected void when_i_add_domain() {
        try {
            attachedFileService.create("test", "hello".getBytes(), "test",
                attachedFileAnnotation.getId(), attachedFileAnnotation.getClass().getName());
    ...
    public void user_can_add_for_image() {
        ...
        expectOK(() -> attachedFileService.create("test", "hello".getBytes(), "test",
            attachedFileImage.getId(), attachedFileImage.getClass().getName()));
    }
    ...
    public void user_cannot_add_in_restricted_mode_for_image() {
        ...
        expectForbidden(() -> attachedFileService.create("test", "hello".getBytes(), "test",
            attachedFileImage.getId(), attachedFileImage.getClass().getName()));
    }
