...
public class UserAnnotation extends AnnotationDomain implements Serializable {
    ...
    public static JsonObject getDataFromDomain(CytomineDomain domain) {
        ...
        returnArray.put("cropURL",
            UrlApi.getUserAnnotationCropWithAnnotationId(annotation.getId(), "png"));
        returnArray.put("smallCropURL",
            UrlApi.getUserAnnotationCropWithAnnotationIdWithMaxSize(annotation.getId(), 256, "png"
            ));
        returnArray.put("url", UrlApi.getUserAnnotationCropWithAnnotationId(annotation.getId(),
            "png"));
     ...
     * If review is done "for all" (without manual user control), we add these term to the new
     * review annotation
     *
     * @return
     */
    ...
    public CytomineDomain buildDomainFromJson(JsonObject json, EntityManager entityManager) {
        ...
        if (json.containsKey("userObject")) {
            ...
            annotation.user = (User) json.getJSONAttrDomain(entityManager, "user", new User(),
                true);
        }
