...
public class Project extends CytomineDomain {
    ...
    public static JsonObject getDataFromDomain(CytomineDomain domain) {
        ...
        returnArray.put("ontology", (project.getOntology() != null ?
            project.getOntology().getId() : null));
        returnArray.put("ontologyName", (project.getOntology() != null ?
            project.getOntology().getName() : null));

        returnArray.put("blindMode", project.getBlindMode() != null && project.getBlindMode());
        returnArray.put("areImagesDownloadable",
    ...
    public CytomineDomain buildDomainFromJson(JsonObject json, EntityManager entityManager) {
        ...
        project.ontology = (Ontology) json.getJSONAttrDomain(entityManager, "ontology",
            new Ontology(), false);
