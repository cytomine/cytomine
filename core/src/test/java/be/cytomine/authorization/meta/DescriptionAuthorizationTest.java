...
public class DescriptionAuthorizationTest extends CRUDAuthorizationTest {
    ...
    protected void when_i_edit_domain() {
        descriptionService.update(descriptionForAnnotation,
            descriptionForAnnotation.toJsonObject());
    }
    ...
    public void user_can_edit_for_image() {
        expectOK(() -> descriptionService.update(descriptionForImageInstance,
            descriptionForImageInstance.toJsonObject(), null, null));
    }
    ...
    public void user_can_edit_in_restricted_mode_for_image_if_owner() {
        ...
        expectOK(() -> descriptionService.update(descriptionForImage,
            descriptionForImage.toJsonObject(), null));
    }
    ...
    public void guest_cannot_edit_image() {
        Description descriptionForImage = builder.given_a_description(imageInstance);
        expectForbidden(() -> descriptionService.update(descriptionForImage,
            descriptionForImage.toJsonObject(), null));
    }
    ...
    public void user_can_delete_in_restricted_mode_for_image_if_owner() {
        ...
        imageInstance.getProject().setMode(EditingMode.RESTRICTED);
        imageInstance.setUser(userRepository.findByUsernameLikeIgnoreCase(USER_ACL_READ).get());
        expectOK(() -> descriptionService.delete(builder.given_a_description(imageInstance), null
            , null, true));
    }
    ...
    public void guest_cannot_delete_for_image() {
        expectForbidden(() -> descriptionService.delete(descriptionForImageInstance, null, null,
            true));
    }
    ...
    public void admin_can_edit_for_project() {
        expectOK(() -> descriptionService.update(descriptionForProject,
            descriptionForProject.toJsonObject(), null, null));
    }

    @Test
    @WithMockUser(username = USER_ACL_READ)
    public void user_with_read_cannot_edit_for_project() {
        expectForbidden(() -> descriptionService.update(descriptionForProject,
            descriptionForProject.toJsonObject(), null, null));
    }
    ...
    public void user_with_write_can_delete_for_project() {
        Project projectLocal = builder.given_a_project();
        initACL(projectLocal);
        expectOK(() -> descriptionService.delete(builder.given_a_description(projectLocal), null,
            null, true));
    }
