...
public class ReportFormatService {
     ...
     * @return Object[][]
     */
    public Object[][] formatMapForReport(List<ReportColumn> columns,
     ...
     * @return Object[][]
     */
    public Object[][] formatAnnotationsForReport(List<ReportColumn> columns, List<Map<String,
        Object>> data) {
        Object[] headers = getColumnHeaders(columns);
        Object[][] report = initReport(data, headers);
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            for (int j = 0; j < headers.length; j++) {
                ...
                Object value = getAnnotationValue(element.get(headers[j]), element,
                    headers[j].toString());
