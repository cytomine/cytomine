...
public class ClassUtils {
    ...
    public static String getClassName(Object o) {
        ...
        if (exeed != -1) {
            name = name.substring(0, exeed); //if ex be.cytomine.image.Image_$$_javassistxxxx..
            // .remove all after  _$$
        } else if (o instanceof HibernateProxy hibernateProxy) {
            name = hibernateProxy.getClass().getSuperclass().getName(); // if ex be.cytomine
            // .image.Image$HibernateProxy$GfTtnrQ6, take the super class (Image)
        }
