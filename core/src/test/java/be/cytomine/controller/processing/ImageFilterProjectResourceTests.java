...
public class ImageFilterProjectResourceTests {
    ...
    public void list_by_project() throws Exception {
        ImageFilterProject imageFilterProject = builder.given_a_image_filter_project();
        restImageFilterProjectMockMvc.perform(get("/api/project/{id}/imagefilterproject.json",
    ...
    public void delete_valid_imageFilterProject() throws Exception {
        ImageFilterProject imageFilterProject =
            builder.given_a_image_filter_project(builder.given_a_image_filter(),
                builder.given_a_project());
        builder.persistAndReturn(imageFilterProject);
        restImageFilterProjectMockMvc.perform(delete("/api/imagefilterproject/{id}.json",
                imageFilterProject.getId())
                .contentType(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk());
    }
