...
public class AnnotationTrack extends CytomineDomain implements Serializable {
    ...
    public static JsonObject getDataFromDomain(CytomineDomain domain) {
        ...
        returnArray.put("track", (annotationTrack.getTrack() != null ?
            annotationTrack.getTrack().getId() : null));
        returnArray.put("slice", (annotationTrack.getSlice() != null ?
            annotationTrack.getSlice().getId() : null));
    ...
    public CytomineDomain buildDomainFromJson(JsonObject json, EntityManager entityManager) {
        ...
        AnnotationDomain annotation = AnnotationDomain.getAnnotationDomain(entityManager,
            annotationId, annotationClassName);
        annotationTrack.setAnnotation(annotation);

        annotationTrack.slice = (SliceInstance) json.getJSONAttrDomain(entityManager, "slice",
            new SliceInstance(), false);
        annotationTrack.track = (Track) json.getJSONAttrDomain(entityManager, "track",
            new Track(), false);
