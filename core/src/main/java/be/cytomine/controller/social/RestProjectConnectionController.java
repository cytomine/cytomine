...
public class RestProjectConnectionController extends RestCytomineController {
    ...
    public ResponseEntity<String> add(
        ...
        return responseSuccess(projectConnectionService.add(currentUserService.getCurrentUser(),
            project, session, os, browser, browserVersion));
    ...
    public ResponseEntity<String> lastConnectionInProject(
        ...
        Project project = projectService.find(projectId)
            .orElseThrow(() -> new ObjectNotFoundException("Project", projectId));
        return responseSuccess(projectConnectionService.lastConnectionInProject(project, null,
            "created", "desc", 0L, 0L));
    ...
    public ResponseEntity<String> lastConnectionInProjectByUser(
        ...
        Project project = projectService.find(projectId)
            .orElseThrow(() -> new ObjectNotFoundException("Project", projectId));
        return responseSuccess(projectConnectionService.lastConnectionInProject(project,
            List.of(userId), "created", "desc", 0L, 0L));
    ...
    public ResponseEntity<String> getConnectionByUserAndProject(
        ...
        return responseSuccess(projectConnectionService.getConnectionByUserAndProject(user,
            project, max, offset));
    ...
    public ResponseEntity<String> numberOfConnectionsByProject(
        ...
        if (heatmap) {
            ...
            return responseSuccess(projectConnectionService.numberOfProjectConnections(period,
                afterThan, null, project, null));
        } else {
    ...
    public ResponseEntity<String> lastConnectionInProjectByUser(
        ...
        return responseSuccess(projectConnectionService.numberOfProjectConnections(period,
            afterThan, beforeThan, null, null));
    }
    ...
    public ResponseEntity<String> averageOfProjectConnections(
        ...
        return responseSuccess(projectConnectionService.averageOfProjectConnections(period,
            afterThan, beforeThan, project, user));
    }
    ...
    public ResponseEntity<String> countByProject(
        ...
        return responseSuccess(JsonObject.of("total",
            projectConnectionService.countByProject(project, startDate, endDate)));
    }
    ...
    public ResponseEntity<String> userProjectConnectionHistory(
        ...
        Page<PersistentProjectConnection> page =
            projectConnectionService.getConnectionByUserAndProject(user, project, max, offset);
        ...
        if (export != null && export.equals("csv")) {
            ...
            byte[] report = reportService.generateConnectionHistoryReport(project.getName(),
                user.getUsername(), projectConnectionDataList);
            responseReportFile(reportService.getConnectionHistoryReportFileName(export, projectId
    ...
    public ResponseEntity<String> getUserActivityDetails(
        ...
        @RequestParam(required = false, defaultValue = "0", value = "start") Integer max, // why
        // not max?
        @RequestParam(required = false, defaultValue = "0", value = "length") Integer offset,  //
        // why not length?
        @RequestParam(required = false) String export
    ) {

        List<PersistentImageConsultation> result =
            projectConnectionService.getUserActivityDetails(id);
