...
public class RelationTermAuthorizationTest extends CRDAuthorizationTest {
    ...
    public void when_i_get_domain() {
        relationTermService.find(relationTerm.getRelation(), relationTerm.getTerm1(),
    ...
    protected void when_i_delete_domain() {
        RelationTerm termToDelete = builder.given_a_relation_term(relationTerm.getRelation(),
            relationTerm.getTerm1(), builder.given_a_term(relationTerm.getTerm1().getOntology()));
