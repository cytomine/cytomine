...
public interface AnnotationIndexRepository extends JpaRepository<AnnotationIndex, Long>,
    JpaSpecificationExecutor<AnnotationIndex> {

    @Query(value = "SELECT user_id as user, slice_id as slice ,count_annotation as " +
        "countAnnotation,count_reviewed_annotation as countReviewedAnnotation " +
    ...
    Optional<AnnotationIndexLightDTO> findOneBySliceInAndUser(List<SliceInstance> slices,
                                                              User user);
