...
public class AnnotationActionService {
    ...
    public AnnotationAction add(AnnotationDomain annotation, User user, String action,
                                Date created) {
    ...
    public List<AnnotationAction> list(SliceInstance sliceInstance, User user, Long afterThan,
                                       Long beforeThan) {
    ...
    public List<AnnotationAction> list(ImageInstance imageInstance, User user, Long afterThan,
                                       Long beforeThan) {
    ...
    public Long countByProject(Project project, Long startDate, Long endDate) {
        if (startDate == null && endDate == null) {
            ...
            return annotationActionRepository.countByProjectAndCreatedAfter(project.getId(),
                new Date(startDate));
        } else if (startDate == null) {
            return annotationActionRepository.countByProjectAndCreatedBefore(project.getId(),
                new Date(endDate));
        } else {
            return annotationActionRepository.countByProjectAndCreatedBetween(project.getId(),
