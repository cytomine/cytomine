...
public class PropertyResourceTests {
    ...
    public void list_all_property_for_project() throws Exception {
        ...
        restPropertyControllerMockMvc.perform(get("/api/project/{project}/property.json",
                property.getDomainIdent()))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection", hasSize(greaterThan(0))))
            .andExpect(jsonPath("$.collection[?(@.domainIdent=='" + property.getDomainIdent() +
                "')]").exists());
    }
    ...
    public void list_all_property_for_annotation() throws Exception {
        ...
        restPropertyControllerMockMvc.perform(get("/api/annotation/{annotation}/property.json",
                property.getDomainIdent()))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection", hasSize(greaterThan(0))))
            .andExpect(jsonPath("$.collection[?(@.domainIdent=='" + property.getDomainIdent() +
    ...
    public void list_all_property_for_image() throws Exception {
        ...
        restPropertyControllerMockMvc.perform(get("/api/imageinstance/{image}/property.json",
                property.getDomainIdent()))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection", hasSize(greaterThan(0))))
            .andExpect(jsonPath("$.collection[?(@.domainIdent=='" + property.getDomainIdent() +
    ...
    public void list_all_property_for_domain() throws Exception {
        Property property = builder.given_a_property(builder.given_an_image_instance());
        restPropertyControllerMockMvc.perform(get("/api/domain/{domainClassName}/{domainIdent" +
                    "}/property.json",
    ...
    public void list_annotation_position() throws Exception {
        UserAnnotation userAnnotation = builder.given_a_user_annotation();
        Property property = builder.given_a_property(userAnnotation);
        restPropertyControllerMockMvc.perform(get("/api/user/{user}/imageinstance/{image" +
                    "}/annotationposition.json",
    ...
    public void show_property_for_project() throws Exception {
        Property property = builder.given_a_property(builder.given_a_project());
        restPropertyControllerMockMvc.perform(get("/api/project/{project}/key/{key}/property" +
                ".json", property.getDomainIdent(), property.getKey()))
            .andExpect(status().isOk())
    ...
    public void show_property_for_project_key_not_exists() throws Exception {
        Property property = builder.given_a_property(builder.given_a_project());
        restPropertyControllerMockMvc.perform(get("/api/project/{project}/key/{key}/property" +
                ".json", property.getDomainIdent(), "xxx"))
            .andExpect(status().isNotFound());
    }
    ...
    public void show_property_for_annotation() throws Exception {
        Property property = builder.given_a_property(builder.given_a_user_annotation());
        restPropertyControllerMockMvc.perform(get("/api/annotation/{annotation}/key/{key" +
                "}/property.json", property.getDomainIdent(), property.getKey()))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.key").value(property.getKey()));
    }
    ...
    public void show_property_for_annotation_key_not_exists() throws Exception {
        Property property = builder.given_a_property(builder.given_a_user_annotation());
        restPropertyControllerMockMvc.perform(get("/api/annotation/{annotation}/key/{key" +
                "}/property.json", property.getDomainIdent(), "xxx"))
            .andExpect(status().isNotFound());
    }
    ...
    public void show_property_for_image() throws Exception {
        Property property = builder.given_a_property(builder.given_an_image_instance());
        restPropertyControllerMockMvc.perform(get("/api/imageinstance/{imageinstance}/key/{key" +
                "}/property.json", property.getDomainIdent(), property.getKey()))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.key").value(property.getKey()));
    }
    ...
    public void add_valid_property() throws Exception {
        Property property = builder.given_a_not_persisted_property(builder.given_a_project(),
            "key", "value");
        restPropertyControllerMockMvc.perform(post("/api/domain/{domainClassName}/{domainIdent" +
                "}/property.json", property.getDomainClassName(), property.getDomainIdent())
    ...
    public void add_valid_properties_by_batch() throws Exception {
        ...
        restPropertyControllerMockMvc.perform(post("/api/domain/{domainClassName}/{domainIdent" +
                "}/property.json", property1.getDomainClassName(), property1.getDomainIdent())
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonObject.toJsonString(List.of(property1.toJsonObject(),
                    property2.toJsonObject()))))
            .andExpect(status().isOk());
    }
    ...
    public void edit_valid_property() throws Exception {
        ...
        restPropertyControllerMockMvc.perform(put("/api/domain/{domainClassName}/{domainIdent" +
                    "}/property/{id}.json", property.getDomainClassName(),
                property.getDomainIdent(),
                property.getId())
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void delete_property() throws Exception {
        Property property = builder.given_a_not_persisted_property(builder.given_a_project(),
            "key", "value");
        builder.persistAndReturn(property);
        restPropertyControllerMockMvc.perform(delete("/api/domain/{domainClassName}/{domainIdent" +
                    "}/property/{id}.json", property.getDomainClassName(),
                property.getDomainIdent(),
                property.getId())
                .contentType(MediaType.APPLICATION_JSON))
