...
public class RelationTerm extends CytomineDomain implements Serializable {
    ...
    public CytomineDomain buildDomainFromJson(JsonObject json, EntityManager entityManager) {
        ...
        relationTerm.relation = (Relation) json.getJSONAttrDomain(entityManager, "relation",
            new Relation(), true);
        relationTerm.term1 = (Term) json.getJSONAttrDomain(entityManager, "term1", new Term(),
            true);
        relationTerm.term2 = (Term) json.getJSONAttrDomain(entityManager, "term2", new Term(),
            true);
