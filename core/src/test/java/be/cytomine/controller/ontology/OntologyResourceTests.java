...
//                .andExpect(jsonPath("$.children[?(@.name=='"+parent.getName()+"')].parent")
//                .value(nullValue())) // does not work :(
            ...
            .andExpect(jsonPath("$.children[?(@.name=='" + parent.getName() + "')].children[?(@" +
                ".name=='" + child1.getName() + "')]").exists())
            .andExpect(jsonPath("$.children[?(@.name=='" + parent.getName() + "')].children[?(@" +
                ".name=='" + child1.getName() + "')].id").value(child1.getId().intValue()))
            .andExpect(jsonPath("$.children[?(@.name=='" + parent.getName() + "')].children[?(@" +
                ".name=='" + child1.getName() + "')].isFolder").value(false))
            .andExpect(jsonPath("$.children[?(@.name=='" + parent.getName() + "')].children[?(@" +
                ".name=='" + child1.getName() + "')].parent").value(parent.getId().intValue()))

            .andExpect(jsonPath("$.children[?(@.name=='" + parent.getName() + "')].children[?(@" +
                ".name=='" + child2.getName() + "')]").exists())
            .andExpect(jsonPath("$.children[?(@.name=='" + parent.getName() + "')].children[?(@" +
                ".name=='" + child2.getName() + "')].id").value(child2.getId().intValue()))
            .andExpect(jsonPath("$.children[?(@.name=='" + parent.getName() + "')].children[?(@" +
                ".name=='" + child2.getName() + "')].isFolder").value(false))
            .andExpect(jsonPath("$.children[?(@.name=='" + parent.getName() + "')].children[?(@" +
                ".name=='" + child2.getName() + "')].parent").value(parent.getId().intValue()))
