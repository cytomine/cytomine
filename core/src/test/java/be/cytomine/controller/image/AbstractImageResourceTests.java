...
public class AbstractImageResourceTests {
    ...
    public void list_abstract_image_by_width() throws Exception {
        ...
        restAbstractImageControllerMockMvc.perform(get("/api/abstractimage.json").param("width" +
                "[lte]", "501"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection", hasSize(greaterThanOrEqualTo(2))))
            .andExpect(jsonPath("$.collection[?(@.id==" + img500Width.getId() + ")]").exists())
        ...
        restAbstractImageControllerMockMvc.perform(get("/api/abstractimage.json").param("width" +
                "[lte]", String.valueOf(Integer.MAX_VALUE)))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection[?(@.id==" + img500Width.getId() + ")]").exists())
            .andExpect(jsonPath("$.collection[?(@.id==" + img501Width.getId() + ")]").exists());
    ...
    public void list_abstract_image_by_projects() throws Exception {
        ...
        restAbstractImageControllerMockMvc.perform(get("/api/abstractimage.json").param("project"
                , String.valueOf(project1.getId())))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection[?(@.id==" + imageInProject1.getId() + ")].inProject"
            ).value(true))
            .andExpect(jsonPath("$.collection[?(@.id==" + imageInProject2.getId() + ")].inProject"
            ).value(false))
            .andExpect(jsonPath("$.collection[?(@.id==" + imageInProject1And2.getId() + ")]" +
                ".inProject").value(true));

        restAbstractImageControllerMockMvc.perform(get("/api/abstractimage.json").param("project"
                , String.valueOf(project2.getId())))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection[?(@.id==" + imageInProject1.getId() + ")].inProject"
            ).value(false))
            .andExpect(jsonPath("$.collection[?(@.id==" + imageInProject2.getId() + ")].inProject"
        ...
        restAbstractImageControllerMockMvc.perform(get("/api/abstractimage.json").param("project"
                , String.valueOf(anotherProject.getId())))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection[?(@.id==" + imageInProject1.getId() + ")].inProject"
            ).value(false))
            .andExpect(jsonPath("$.collection[?(@.id==" + imageInProject2.getId() + ")].inProject"
    ...
    public void list_abstract_image_with_ordering() throws Exception {
        ...
        restAbstractImageControllerMockMvc.perform(get("/api/abstractimage.json")// default
        ...
        MvcResult mvcResult = restAbstractImageControllerMockMvc.perform(get("/api/abstractimage" +
                ".json")
                .param("sort", "width")
                .param("order", "desc"))
            .andExpect(status().isOk())
        ...
        List<Long> ids =
            objectList.stream().map(x -> Long.valueOf((int) x.get("id"))).collect(Collectors.toList());
    ...
    public void get_an_abstract_image() throws Exception {
        ...
        restAbstractImageControllerMockMvc.perform(get("/api/abstractimage/{id}.json",
                image.getId()))
            .andExpect(status().isOk())
    ...
    public void get_an_abstract_image_from_uploaded_file() throws Exception {
        ...
        restAbstractImageControllerMockMvc.perform(get("/api/uploadedfile/{id}/abstractimage" +
                ".json", image.getUploadedFile().getId()))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.id").value(image.getId().intValue()));
    }
    ...
    public void edit_valid_abstract_image() throws Exception {
        ...
        restAbstractImageControllerMockMvc.perform(put("/api/abstractimage/{id}.json",
                abstractImage.getId())
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void delete_abstract_image() throws Exception {
        AbstractImage abstractImage = builder.given_an_abstract_image();
        restAbstractImageControllerMockMvc.perform(delete("/api/abstractimage/{id}.json",
                abstractImage.getId()))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.printMessage").value(true))
            .andExpect(jsonPath("$.callback").exists())
    ...
    public void list_unused_abstract_image() throws Exception {
        ...
        restAbstractImageControllerMockMvc.perform(get("/api/abstractimage/unused.json"))
            ...
            .andExpect(jsonPath("$.collection[?(@.id==" + imageWithoutImageInstance.getId() + ")" +
                "]").exists());
    ...
    public void get_abstract_image_uploader() throws Exception {
        ...
        restAbstractImageControllerMockMvc.perform(get("/api/abstractimage/{id}/user.json",
                image.getId()))
            .andExpect(status().isOk())
    ...
    public void get_abstract_image_thumb() throws Exception {
        ...
        stubFor(get(urlEqualTo(IMS_API_BASE_PATH + "/image/" + URLEncoder.encode(image.getPath(),
            StandardCharsets.UTF_8).replace("%2F", "/") + "/thumb?z_slices=0&timepoints=0&length" +
            "=512"))
            .willReturn(
    ...
    public void get_abstract_image_thumb_if_image_not_exist() throws Exception {
        restAbstractImageControllerMockMvc.perform(get("/api/abstractimage/{id}/thumb" +
    ...
    public void get_abstract_image_associeted_label() throws Exception {
        ...
        configureFor("localhost", 8888);
        stubFor(get(urlEqualTo(IMS_API_BASE_PATH + "/image/" + URLEncoder.encode(image.getPath(),
            StandardCharsets.UTF_8).replace("%2F", "/") + "/info/associated"))
            .willReturn(
                aResponse().withBody("{\"items\": [{\"name\":\"macro\"},{\"name\":\"thumbnail\"}," +
                    "{\"name\":\"label\"}], \"size\": 0}")
            )
        );
        restAbstractImageControllerMockMvc.perform(get("/api/abstractimage/{id}/associated.json",
                image.getId()))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection", hasSize(equalTo(3))))
    ...
    public void get_abstract_image_associeted_label_macro() throws Exception {
        ...
        String url =
            "/image/" + URLEncoder.encode(image.getPath(), StandardCharsets.UTF_8).replace("%2F",
                "/") + "/associated/macro?length=512";
    ...
    public void get_abstract_image_crop() throws Exception {
        ...
        String url =
            "/image/" + URLEncoder.encode(image.getPath(), StandardCharsets.UTF_8).replace("%2F",
                "/") + "/annotation/crop";
        String body = "{\"level\":0,\"z_slices\":0,\"annotations\":[{\"geometry\":\"POLYGON ((1 " +
            "1, 50 10, 50 50, 10 50, 1 1))\"}],\"timepoints\":0,\"background_transparency\":0}";
        System.out.println(url);
    ...
    public void download_abstract_image() throws Exception {
        ...
        configureFor("localhost", 8888);
        stubFor(get(urlEqualTo(IMS_API_BASE_PATH + "/image/" + URLEncoder.encode(image.getPath(),
            StandardCharsets.UTF_8).replace("%2F", "/") + "/export?filename=" + URLEncoder.encode(image.getOriginalFilename(), StandardCharsets.UTF_8)))
            .willReturn(
                aResponse().withBody(mockResponse)
            )
        );
    ...
    public void get_abstract_image_metadata() throws Exception {
        ...
        configureFor("localhost", 8888);
        stubFor(get(urlEqualTo(IMS_API_BASE_PATH + "/image/" + URLEncoder.encode(image.getPath(),
            StandardCharsets.UTF_8).replace("%2F", "/") + "/metadata"))
            .willReturn(
        ...
        restAbstractImageControllerMockMvc.perform(get("/api/abstractimage/{id}/metadata.json",
                image.getId()))
            .andExpect(status().isOk())
    ...
    public void regenarate_properties_to_abstract_image() throws Exception {
        ...
        configureFor("localhost", 8888);
        stubFor(get(urlEqualTo(IMS_API_BASE_PATH + "/image/" + URLEncoder.encode(image.getPath(),
            StandardCharsets.UTF_8).replace("%2F", "/") + "/info"))
            .willReturn(
                aResponse().withBody(
                    """
                        {"image":
        ...
        restAbstractImageControllerMockMvc.perform(post("/api/abstractimage/{id}/properties" +
                "/regenerate.json", image.getId()))
            .andExpect(status().isOk());
