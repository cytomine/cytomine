...
public class Lock {
    ...
    public boolean lockProject(Project project) {
        try {
            ...
            log.debug("Project {} current lock {}", project.getId(),
                projectLocks.get(project.getId()).isLocked());
    ...
    public boolean lockCustomUI(Project project) {
        try {
            ...
            log.debug("Custom UI Project {} current lock {}", project.getId(),
    ...
    public boolean lockUsedWsSession(String userId) {
        try {
            ...
            log.debug("WebSocket session of user {} current lock {}", userId,
                wsSessionsLock.get(userId).isLocked());
