...
public class AnnotationListingBuilder {
    ...
    public byte[] buildAnnotationReport(Long project, String users, JsonObject params,
    ...
    public AnnotationListing buildAnnotationListing(AnnotationListing al, JsonObject params) {
        ...
        al.setUsersForTerm(StringUtils.extractListFromParameter(params.getJSONAttrStr(
            "usersForTerm")));
        ...
        if (params.get("bbox") != null) {
            try {
                ...
                throw new WrongArgumentException("Geometry cannot be parsed for annotation search" +
                    " request:" + e);
            }
        }
        if (params.get("bboxAnnotation") != null) {
            AnnotationDomain annotationDomain =
                AnnotationDomain.getAnnotationDomain(entityManager, params.getJSONAttrLong(
                    "bboxAnnotation"));
