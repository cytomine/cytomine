...
public interface AnnotationTermRepository extends JpaRepository<AnnotationTerm, Long>,
    JpaSpecificationExecutor<AnnotationTerm> {
    ...
    Optional<AnnotationTerm> findByUserAnnotationAndTermAndUser(UserAnnotation annotation,
                                                                Term term, User user);


    Optional<AnnotationTerm> findByUserAnnotationIdAndTermIdAndUserId(Long annotation, Long term,
                                                                      Long user);
