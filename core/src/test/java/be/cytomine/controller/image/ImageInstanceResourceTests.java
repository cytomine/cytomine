...
public class ImageInstanceResourceTests {
    ...
    private ImageInstance given_test_image_instance() {
        ...
        ImageInstance imageInstance = builder.given_an_image_instance(image,
    ...
    public void get_an_image_instance() throws Exception {
        ...
        restImageInstanceControllerMockMvc.perform(get("/api/imageinstance/{id}.json",
                image.getId()))
    ...
    public void get_slice_instance_reference() throws Exception {
        ImageInstance image = given_test_image_instance();
        restImageInstanceControllerMockMvc.perform(get("/api/imageinstance/{id}/sliceinstance" +
                "/reference.json", image.getId()))
            .andExpect(status().isOk());
    }
    ...
    public void get_image_instance_bounds() throws Exception {
        ...
        restImageInstanceControllerMockMvc.perform(get("/api/project/{id}/bounds/imageinstance" +
                ".json", image.getProject().getId()))
            .andExpect(status().isOk())
    ...
    public void list_image_instance_by_user() throws Exception {
        ...
        restImageInstanceControllerMockMvc.perform(get("/api/user/{id}/imageinstance.json",
                user.getId()))
            .andExpect(status().isOk())
        ...
        restImageInstanceControllerMockMvc.perform(get("/api/user/{id}/imageinstance.json",
                user.getId()).param("width[lte]", "500"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection[?(@.id==" + image.getId() + ")]").exists());

        restImageInstanceControllerMockMvc.perform(get("/api/user/{id}/imageinstance.json",
                user.getId()).param("width[gte]", "501"))
            .andExpect(status().isOk())
    ...
    public void list_image_instance_light_by_user() throws Exception {
        ...
        restImageInstanceControllerMockMvc.perform(get("/api/user/{id}/imageinstance/light.json",
                user.getId()))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection[?(@.id==" + image.getId() + ")]").exists())
            .andExpect(jsonPath("$.collection[?(@.id==" + imageFromOtherProjectNotAccessibleForUser.getId() + ")]").doesNotExist());
    ...
    public void list_image_instance_by_projects() throws Exception {
        ...
        ImageInstance imageInProject1 =
            builder.given_an_image_instance(builder.given_an_abstract_image(), project1);
        ImageInstance imageInAnotherProject =
            builder.given_an_image_instance(builder.given_an_abstract_image(), anotherProject);


        restImageInstanceControllerMockMvc.perform(get("/api/project/{id}/imageinstance.json",
                project1.getId()))
            .andExpect(status().isOk())
    ...
    public void list_image_instance_light() throws Exception {
        ...
        restImageInstanceControllerMockMvc.perform(get("/api/project/{id}/imageinstance.json",
            ...
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection[?(@.id==" + imageInProject1.getId() + ")]").exists())
            .andExpect(jsonPath("$.collection[?(@.id==" + imageInProject1.getId() + ")]" +
                ".instanceFilename").value(imageInProject1.getBlindInstanceFilename()))
            .andExpect(jsonPath("$.collection[?(@.id==" + imageInAnotherProject.getId() + ")]").doesNotExist());
    }
    ...
    public void list_image_instance_by_projects_tree() throws Exception {
        ...
        ImageInstance image1InProject1 =
            builder.given_an_image_instance(builder.given_an_abstract_image(), project1);
        ImageInstance image2InProject1 =
            builder.given_an_image_instance(builder.given_an_abstract_image(), project1);
    ...
    public void list_image_instance_by_project_with_annotation_filter() throws Exception {
        ...
        ImageInstance image1 = builder.given_an_image_instance(builder.given_an_abstract_image(),
            project);
        image1.setCountImageAnnotations(2L);
        ImageInstance image2 = builder.given_an_image_instance(builder.given_an_abstract_image(),
            project);
    ...
    public void list_image_instance_by_project_with_pagination() throws Exception {
        ...
        ImageInstance image3 = builder.given_an_image_instance(builder.given_an_abstract_image(),
            project);
        ...
        restImageInstanceControllerMockMvc.perform(get("/api/project/{id}/imageinstance.json",
            ...
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection", hasSize(greaterThanOrEqualTo(3)))) // default
            // sorting must be created desc
        ...
        restImageInstanceControllerMockMvc.perform(get("/api/project/{id}/imageinstance.json",
            ...
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection", hasSize(equalTo(1)))) // default sorting must be
            // created desc
            .andExpect(jsonPath("$.collection[0].id").value(image3.getId()))
            .andExpect(jsonPath("$.offset").value(0))
        ...
        restImageInstanceControllerMockMvc.perform(get("/api/project/{id}/imageinstance.json",
                ...
                .param("width[equals]", String.valueOf(width)))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection", hasSize(equalTo(2)))) // default sorting must be
            // created desc
            .andExpect(jsonPath("$.collection[0].id").value(image2.getId()))
        ...
        restImageInstanceControllerMockMvc.perform(get("/api/project/{id}/imageinstance.json",
                ...
                .param("width[equals]", String.valueOf(width)))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection", hasSize(equalTo(3)))) // default sorting must be
            // created desc
            .andExpect(jsonPath("$.collection[0].id").value(image3.getId()))
            .andExpect(jsonPath("$.collection[1].id").value(image2.getId()))
            .andExpect(jsonPath("$.collection[2].id").value(image1.getId()))
        ...
        restImageInstanceControllerMockMvc.perform(get("/api/project/{id}/imageinstance.json",
                ...
                .param("width[equals]", String.valueOf(width)))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection", hasSize(equalTo(0)))) // default sorting must be
            // created desc
    ...
    public void get_next_image_instance() throws Exception {
        ...
        restImageInstanceControllerMockMvc.perform(get("/api/imageinstance/{id}/next.json",
    ...
    public void get_previous_image_instance() throws Exception {
        ...
        restImageInstanceControllerMockMvc.perform(get("/api/imageinstance/{id}/previous.json",
                imageInstance1.getId()))
            .andExpect(status().isOk())
    ...
    public void edit_valid_image_instance() throws Exception {
        ...
        restImageInstanceControllerMockMvc.perform(put("/api/imageinstance/{id}.json",
                imageInstance.getId())
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void delete_image_instance() throws Exception {
        ImageInstance imageInstance = builder.given_an_image_instance();
        restImageInstanceControllerMockMvc.perform(delete("/api/imageinstance/{id}.json",
                imageInstance.getId()))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.printMessage").value(true))
            .andExpect(jsonPath("$.callback").exists())
    ...
    public void get_image_instance_thumb() throws Exception {
        ...
        byte[] mockResponse = UUID.randomUUID().toString().getBytes(); // we don't care about the
        // response content, we just check that core build a valid ims url and return the content
        ...
        MvcResult mvcResult = restImageInstanceControllerMockMvc.perform(get("/api/imageinstance" +
                    "/{id}/thumb.png?maxSize=512&Authorization=Bearer " + getSignedNotExpiredJwt(),
                image.getId()))
            .andExpect(status().isOk())
            .andReturn();
    ...
    public void get_image_instance_thumb_if_image_not_exist() throws Exception {
        restImageInstanceControllerMockMvc.perform(get("/api/imageinstance/{id}/thumb" +
                ".png?Authorization=Bearer " + getSignedNotExpiredJwt(), 0))
            .andExpect(status().isNotFound())
    ...
    public void get_image_instance_preview() throws Exception {
        ...
        MvcResult mvcResult = restImageInstanceControllerMockMvc.perform(get("/api/imageinstance" +
                "/{id}/preview.png?maxSize=1024", image.getId()))
            .andExpect(status().isOk())
            .andReturn();
        List<LoggedRequest> all = wireMockServer.findAll(RequestPatternBuilder.allRequests());
        assertThat(mvcResult.getResponse().getContentAsByteArray()).isEqualTo(mockResponse);
    ...
    public void get_image_instance_associeted_label() throws Exception {
        ImageInstance image = given_test_image_instance();
        configureFor("localhost", 8888);
        stubFor(get(urlEqualTo(IMS_API_BASE_PATH + "/image/" + URLEncoder.encode("1636379100999" +
            "/CMU-2/CMU-2.mrxs", StandardCharsets.UTF_8).replace("%2F", "/") + "/info/associated"))
            .willReturn(
                aResponse().withBody("{\"items\": [{\"name\":\"macro\"},{\"name\":\"thumbnail\"}," +
                    "{\"name\":\"label\"}], \"size\": 0}")
            )
        );
        restImageInstanceControllerMockMvc.perform(get("/api/imageinstance/{id}/associated.json",
                image.getId()))
            .andExpect(status().isOk())
    ...
    public void get_image_instance_associeted_label_macro() throws Exception {
        ...
        String url = "/image/" + URLEncoder.encode(image.getBaseImage().getPath(),
            StandardCharsets.UTF_8).replace("%2F", "/") + "/associated/macro?length=512";
        ...
        MvcResult mvcResult = restImageInstanceControllerMockMvc.perform(get("/api/imageinstance" +
                "/{id}/associated/{label}.png", image.getId(), "macro")
                .param("maxSize", "512"))
            .andExpect(status().isOk())
            .andReturn();
        List<LoggedRequest> all = wireMockServer.findAll(RequestPatternBuilder.allRequests());
    ...
    public void get_image_instance_crop() throws Exception {
        ...
        MvcResult mvcResult = restImageInstanceControllerMockMvc.perform(get("/api/imageinstance" +
                "/{id}/crop.png?maxSize=512", image.getId())
    ...
    public void get_image_instance_window() throws Exception {
        ...
        String url = "/image/" + URLEncoder.encode(image.getBaseImage().getPath(),
            StandardCharsets.UTF_8).replace("%2F", "/") + "/window";
        String body = "{\"level\":0,\"z_slices\":0,\"timepoints\":0,\"region\":{\"left\":10," +
        ...
        MvcResult mvcResult = restImageInstanceControllerMockMvc.perform(get("/api/imageinstance" +
                "/{id}/window-10-20-30-40.png", image.getId()))
            .andExpect(status().isOk())
            .andReturn();
        List<LoggedRequest> all = wireMockServer.findAll(RequestPatternBuilder.allRequests());
        AssertionsForClassTypes.assertThat(mvcResult.getResponse().getContentAsByteArray()).isEqualTo(mockResponse);
    ...
    public void get_image_instance_metadata() throws Exception {
        ...
        stubFor(get(urlEqualTo(IMS_API_BASE_PATH + "/image/" + URLEncoder.encode(image.getBaseImage().getPath(), StandardCharsets.UTF_8).replace("%2F", "/") + "/metadata"))
            .willReturn(
                aResponse().withBody("{\"size\":11,\"items\":[{\"key\":\"JFIFVersion\"," +
                    "\"value\":1.01,\"type\":\"DECIMAL\",\"namespace\":\"JFIF\"}," +
                    "{\"key\":\"ResolutionUnit\",\"value\":\"inches\",\"type\":\"STRING\"," +
                    "\"namespace\":\"JFIF\"},{\"key\":\"XResolution\"," +
                    "\"value\":300,\"type\":\"INTEGER\",\"namespace\":\"JFIF\"}," +
                    "{\"key\":\"YResolution\",\"value\":300,\"type\":\"INTEGER\"," +
                    "\"namespace\":\"JFIF\"},{\"key\":\"ProfileCMMType\",\"value\":\"Little " +
                    "CMS\",\"type\":\"STRING\",\"namespace\":\"ICC_PROFILE\"}," +
                    ...
                    "\"namespace\":\"ICC_PROFILE\"}," +
                    "{\"key\":\"ProfileDateTime\",\"value\":\"2021:03:02 20:40:36\"," +
                    "\"type\":\"STRING\",\"namespace\":\"ICC_PROFILE\"}," +
                    "{\"key\":\"ProfileFileSignature\",\"value\":\"acsp\",\"type\":\"STRING\"," +
                    "\"namespace\":\"ICC_PROFILE\"}]}")
            )
        );
        restImageInstanceControllerMockMvc.perform(get("/api/imageinstance/{id}/metadata.json",
                image.getId()))
            .andExpect(status().isOk())
    ...
    public void download_image_instance() throws Exception {
        ...
        MvcResult mvcResult = restImageInstanceControllerMockMvc.perform(get("/api/imageinstance" +
                "/{id}/download?Authorization=Bearer " + getSignedNotExpiredJwt(), image.getId()))
            .andExpect(status().isOk())
            .andReturn();
        assertThat(mvcResult.getResponse().getContentAsByteArray()).isEqualTo(mockResponse);
    }
    ...
    public void histograms() throws Exception {
        ...
        configureFor("localhost", 8888);
        System.out.println("/image/" + URLEncoder.encode(image.getBaseImage().getPath(),
            StandardCharsets.UTF_8).replace("%2F", "/") + "/histogram/per-plane/z/0/t/0?n_bins" +
            "=256&channels=0");
        ...
        restImageInstanceControllerMockMvc.perform(get("/api/imageinstance/{id}/histogram.json",
                image.getId()))
            .andExpect(status().isOk())
    ...
    public void histograms_bounds() throws Exception {
        ...
        restImageInstanceControllerMockMvc.perform(get("/api/imageinstance/{id}/histogram/bounds" +
                ".json", image.getId()))
            .andExpect(status().isOk())
    ...
    public void channel_histograms() throws Exception {
        ...
        configureFor("localhost", 8888);
        System.out.println("/image/" + URLEncoder.encode(image.getBaseImage().getPath(),
            StandardCharsets.UTF_8).replace("%2F", "/") + "/histogram/per-channels?n_bins=256");
        ...
        restImageInstanceControllerMockMvc.perform(get("/api/imageinstance/{id}/channelhistogram" +
                ".json", image.getId()))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.collection", hasSize(equalTo(3))))
