...
public abstract class AnnotationDomain extends CytomineDomain implements Serializable {
    ...
    @NotBlank
    @NotNull
    protected String wktLocation; // Redundant, better to use this than getting WKT from location
    // properties
    ...
    public static Optional<AnnotationDomain> findAnnotationDomain(EntityManager entityManager,
                                                                  Long id) {
