...
public class CompanionFile extends CytomineDomain {
    ...
    public CytomineDomain buildDomainFromJson(JsonObject json, EntityManager entityManager) {
        ...
        companionFile.uploadedFile = (UploadedFile) json.getJSONAttrDomain(entityManager,
            "uploadedFile", new UploadedFile(), false);
        companionFile.image = (AbstractImage) json.getJSONAttrDomain(entityManager, "image",
