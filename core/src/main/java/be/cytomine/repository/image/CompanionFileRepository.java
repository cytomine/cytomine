...
@Repository
public interface CompanionFileRepository extends JpaRepository<CompanionFile, Long>,
    JpaSpecificationExecutor<CompanionFile> {
    ...
    Optional<CompanionFile> findByImageAndUploadedFile(AbstractImage abstractImage,
