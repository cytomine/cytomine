...
public interface UserRepository extends JpaRepository<User, Long>, JpaSpecificationExecutor<User> {
    ...
    @Query("select distinct user " +
        "from AclObjectIdentity as aclObjectId, AclEntry as aclEntry, AclSid as aclSid, User as " +
        "user " +
    ...
    @Query("select distinct user " +
        "from  User as user, AclObjectIdentity as aclObjectId, AclEntry as aclEntry, AclSid as " +
        "aclSid " +
    ...
    @Query(value = "select distinct user " +
        ...
        "where aclEntry.aclObjectIdentity in (select  aclEntry.aclObjectIdentity from AclEntry as" +
        " aclEntry where aclEntry.sid.id = :sidId) " +
