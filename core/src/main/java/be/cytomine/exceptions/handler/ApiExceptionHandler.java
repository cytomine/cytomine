...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(
        ...
        JsonObject jsonObject = JsonObject.of(
            "errors",
            Map.of("message", "The body cannot be parsed, is the body content in the good format?")
        );
        return JsonResponseEntity
            .status(HttpStatus.BAD_REQUEST)
            .body(jsonObject.toJsonString());
    ...
    public ResponseEntity<?> handleException(AccessDeniedException exception) {
        JsonObject jsonObject = JsonObject.of(
            "errors",
            Map.of("message", "Cannot identify user or user is not authorized to log in")
        );
        return JsonResponseEntity
            .status(HttpStatus.FORBIDDEN)
            .body(jsonObject.toJsonString());
    ...
    public ResponseEntity<?> handleException(SearchException exception) {
        log.error("Error (code {}): {}", exception.code, exception.body, exception);
        JsonObject jsonObject = JsonObject.of("errors", Map.of("message", exception.getMessage()));
        return JsonResponseEntity
