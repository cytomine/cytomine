...
public class CustomUIControllerTests {
    ...
    public void load_custom_ui_default_config() throws Exception {
        ...
        System.out.println(applicationProperties.getCustomUI().getProject().get("project" +
            "-annotations-tab"));
    ...
    public void retrieve_project_custom_ui_as_superadmin() throws Exception {
        Project project = builder.given_a_project();
        restConfigurationControllerMockMvc.perform(get("/api/custom-ui/project/{project}.json",
                project.getId()))
            .andExpect(status().isOk())
    ...
    public void change_project_custom_ui() throws Exception {
        ...
        restConfigurationControllerMockMvc.perform(post("/api/custom-ui/project/{project}.json",
                project.getId())
