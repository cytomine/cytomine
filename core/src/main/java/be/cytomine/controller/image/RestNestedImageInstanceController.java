...
public class RestNestedImageInstanceController extends RestCytomineController {
    ...
    public ResponseEntity<String> add(@PathVariable Long imageInstanceId,
    ...
    public ResponseEntity<String> edit(@PathVariable Long imageInstanceId,
                                       @PathVariable String id, @RequestBody JsonObject json) {
    ...
    public ResponseEntity<String> delete(@PathVariable Long imageInstanceId,
