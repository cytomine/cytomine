...
public class PropertyAuthorizationTest extends CRUDAuthorizationTest {
    ...
    public void user_can_add_in_restricted_mode_for_annotation_if_owner() {
        ...
        expectOK(() -> {
            ...
            ((UserAnnotation) annotationDomain).setUser(userRepository.findByUsernameLikeIgnoreCase(USER_ACL_READ).get());
            propertyService.add(builder.given_a_not_persisted_property(annotationDomain, "key",
                "value").toJsonObject());
        });
    }
    ...
    public void user_can_add_for_image() {
        ...
        expectOK(() -> propertyService.add(builder.given_a_not_persisted_property(imageInstance,
    ...
    public void user_can_edit_for_image() {
        expectOK(() -> propertyService.update(propertyForImageInstance,
            propertyForImageInstance.toJsonObject(), null, null));
    }
    ...
    public void user_cannot_edit_in_restricted_mode_for_image() {
        ImageInstance imageInstance = builder.given_an_image_instance(project);
        imageInstance.getProject().setMode(EditingMode.RESTRICTED);
        expectForbidden(() -> propertyService.update(builder.given_a_property(imageInstance),
            builder.given_a_property(imageInstance).toJsonObject(), null));
    ...
    public void user_can_edit_in_restricted_mode_for_image_if_owner() {
        ...
        expectOK(() -> propertyService.update(propertyForImageInstance,
            propertyForImageInstance.toJsonObject(), null));
    }
    ...
    public void guest_cannot_edit_image() {
        ...
        expectForbidden(() -> propertyService.update(propertyForImageInstanceLocal,
            propertyForImageInstanceLocal.toJsonObject(), null));
    }
    ...
    public void user_cannot_delete_in_restricted_mode_for_image() {
        ImageInstance imageInstance = builder.given_an_image_instance(project);
        imageInstance.getProject().setMode(EditingMode.RESTRICTED);
        expectForbidden(() -> propertyService.delete(builder.given_a_property(imageInstance),
            null, null, true));
    }
    ...
    public void user_can_delete_in_restricted_mode_for_image_if_owner() {
        ...
        imageInstance.getProject().setMode(EditingMode.RESTRICTED);
        imageInstance.setUser(userRepository.findByUsernameLikeIgnoreCase(USER_ACL_READ).get());
        expectOK(() -> propertyService.delete(builder.given_a_property(imageInstance), null, null
            , true));
    }
    ...
    public void user_with_write_can_add_for_project() {
        ...
        expectOK(() -> propertyService.add(builder.given_a_not_persisted_property(projectLocal,
            "key", "value").toJsonObject()));
    }
    ...
    public void admin_can_edit_for_project() {
        expectOK(() -> propertyService.update(propertyForProject,
            propertyForProject.toJsonObject(), null, null));
    }

    @Test
    @WithMockUser(username = USER_ACL_READ)
    public void user_with_read_cannot_edit_for_project() {
        expectForbidden(() -> propertyService.update(propertyForProject,
            propertyForProject.toJsonObject(), null, null));
    }
    ...
    public void admin_can_delete_for_project() {
        expectOK(() -> propertyService.delete(builder.given_a_property(builder.given_a_project())
            , null, null, true));
    }
    ...
    public void user_with_write_can_delete_for_project() {
        Project projectLocal = builder.given_a_project();
        initACL(projectLocal);
        expectOK(() -> propertyService.delete(builder.given_a_property(projectLocal), null, null,
            true));
    }
