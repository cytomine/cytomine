...
public class NestedImageInstance extends ImageInstance {
    ...
    public CytomineDomain buildDomainFromJson(JsonObject json, EntityManager entityManager) {
        NestedImageInstance nestedImageInstance =
            (NestedImageInstance) super.buildDomainFromJson(this, json, entityManager);
        nestedImageInstance.parent = (ImageInstance) json.getJSONAttrDomain(entityManager,
            "parent", new ImageInstance(), true);
