...
public class ImageConsultationResourceTests {
    ...
    public void add_consultation() throws Exception {
        ...
        restImageConsultationControllerMockMvc.perform(post(
    ...
    public void resume_by_user_and_project_export_as_csv() throws Exception {
        ...
        AssertionsForClassTypes.assertThat(imageConsultationResult[5])
            .isEqualTo(imageInstance1.getBlindInstanceFilename());
        AssertionsForClassTypes.assertThat(imageConsultationResult[6])
            .isEqualTo(serverUrl + "/api/imageinstance/" + imageInstance1.getId() + "/thumb.png?maxSize=512");
