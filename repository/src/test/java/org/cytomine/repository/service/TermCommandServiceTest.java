...
class TermCommandServiceTest {
    ...
    void createThenDeleteThenUndoDeleteThenRedoDelete() {
        ...
        assertEquals(new HttpCommandResponse(
            new Callback(Commands.CREATE_TERM, Optional.of(termId), Optional.of(ontologyId), Optional.empty()), true,
        ...
        assertEquals(new HttpCommandResponse(
            new Callback(Commands.DELETE_TERM, Optional.of(termId), Optional.of(ontologyId), Optional.empty()), true,
    ...
    void createThenUpdateThenUndoUpdateThenRedoUpdate() {
        ...
        assertEquals(new HttpCommandResponse(
            new Callback(Commands.UPDATE_TERM, Optional.of(termId), Optional.of(ontologyId), Optional.empty()), true,
