...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        JsonObject jsonObject = JsonObject.of("errors", Map.of("message", "The body cannot be " +
            "parsed, is the body content in the good format?"));
        return JsonResponseEntity
            .status(HttpStatus.BAD_REQUEST)
            .body(jsonObject.toJsonString());
    }
    ...
    public ResponseEntity<?> handleException(MiddlewareException exception) {
        JsonObject jsonObject = JsonObject.of("errors", Map.of("message", "Internal error"),
            "errorValues", exception.getValues());
        return JsonResponseEntity
    ...
    public ResponseEntity<?> handleException(AccessDeniedException exception) {
        JsonObject jsonObject = JsonObject.of("errors", Map.of("message", "Cannot identify user " +
            "or user is not authorized to log in"));
        return JsonResponseEntity
            .status(HttpStatus.FORBIDDEN)
            .body(jsonObject.toJsonString());
    }
    ...
    public ResponseEntity<?> handleException(CytomineMethodNotYetImplementedException exception) {
        ...
        JsonObject jsonObject = JsonObject.of("errors", Map.of("message", "Method is not yet " +
            "implemented"));
        return JsonResponseEntity
            .status(HttpStatus.INTERNAL_SERVER_ERROR)
            .body(jsonObject.toJsonString());
