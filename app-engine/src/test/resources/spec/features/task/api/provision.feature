Feature: [URS00003-TASK] Provision a task run
  ...
  - '/task-runs/{run_id}/input-provisions/{parameter}'
    ...
    Examples:
      ...
      | com.cytomine.dummy.arithmetic.integer.addition | 1.0.0        | 5                                                   | n_unknown          | integer            | {\"value\": 5, \"param_name\": \"n_unknown\"}                                               | CREATED                | {\"error_code\": \"APPE-internal-parameter-not-found\", \"message\": \"parameter not found\", \"details\": {\"type\":\"parameter\",\"param_name\": \"n_unknown\"}} |
      | com.cytomine.dummy.identity.boolean            | 1.0.0        | false                                               | my_input           | boolean            | {\"param_name\": \"my_input\", \"value\": false}                                            | CREATED                | {\"error_code\": \"APPE-internal-parameter-not-found\", \"message\": \"parameter not found\", \"details\": {\"type\":\"parameter\",\"param_name\": \"my_input\"}}  |
      | com.cytomine.dummy.identity.enumeration        | 1.0.0        | A                                                   | my_input           | enumeration        | {\"param_name\": \"my_input\", \"value\": A}                                                | CREATED                | {\"error_code\": \"APPE-internal-parameter-not-found\", \"message\": \"parameter not found\", \"details\": {\"type\":\"parameter\",\"param_name\": \"my_input\"}}  |
      | com.cytomine.dummy.identity.number             | 1.0.0        | 3.14                                                | my_input           | number             | {\"param_name\": \"my_input\", \"value\": 3.14}                                             | CREATED                | {\"error_code\": \"APPE-internal-parameter-not-found\", \"message\": \"parameter not found\", \"details\": {\"type\":\"parameter\",\"param_name\": \"my_input\"}}  |
      | com.cytomine.dummy.identity.string             | 1.0.0        | \"value\"                                           | my_input           | string             | {\"param_name\": \"my_input\", \"value\": \"value\"}                                        | CREATED                | {\"error_code\": \"APPE-internal-parameter-not-found\", \"message\": \"parameter not found\", \"details\": {\"type\":\"parameter\",\"param_name\": \"my_input\"}}  |
      | com.cytomine.dummy.identity.geometry           | 1.0.0        | { \"type\": \"Point\", \"coordinates\": [1.0, 1.0]} | my_input           | geometry           | {\"param_name\": \"input\", \"value\": { \"type\": \"Point\", \"coordinates\": [1.0, 1.0]}} | CREATED                | {\"error_code\": \"APPE-internal-parameter-not-found\", \"message\": \"parameter not found\", \"details\": {\"type\":\"parameter\",\"param_name\": \"my_input\"}}  |
      | com.cytomine.dummy.identity.image              | 1.0.0        | binary                                              | my_input           | image              | binary                                                                                      | CREATED                | {\"error_code\": \"APPE-internal-parameter-not-found\", \"message\": \"parameter not found\", \"details\": {\"type\":\"parameter\",\"param_name\": \"my_input\"}}  |
      | com.cytomine.dummy.identity.file               | 1.0.0        | binary                                              | my_input           | file               | binary                                                                                      | CREATED                | {\"error_code\": \"APPE-internal-parameter-not-found\", \"message\": \"parameter not found\", \"details\": {\"type\":\"parameter\",\"param_name\": \"my_input\"}}  |
      | com.cytomine.dummy.identity.datetime           | 1.0.0        | 2025-02-23T18:00:00                                 | my_input           | datetime           | {\"param_name\": \"my_input\", \"value\": \"2024-02-23T18:00:00\"}                          | CREATED                | {\"error_code\": \"APPE-internal-parameter-not-found\", \"message\": \"parameter not found\", \"details\": {\"type\":\"parameter\",\"param_name\": \"my_input\"}}  |
      | com.cytomine.dummy.identity.integer.collection | 0.1.0        | [1, 1, 2]                                           | my_input           | array              | {\"param_name\": \"my_input\", \"value\": [1, 1, 2]}                                        | CREATED                | {\"error_code\": \"APPE-internal-parameter-not-found\", \"message\": \"parameter not found\", \"details\": {\"type\":\"parameter\",\"param_name\": \"my_input\"}}  |
  ...
  See "src/main/resources/schemas/tasks/task.v0.json" file for the constraints
    ...
    Examples:
      ...
      | com.cytomine.dummy.constrained.integer.addition | 0.1.0        | a              | 0               | integer        | {\"param_name\": \"a\", \"value\": 0}                   | {\"message\":\"value must be less than defined constraint\",\"details\":{\"type\":\"parameter\",\"param_name\":\"a\"},\"error_code\":\"APPE-internal-request-validation-error\"}                   |
      | com.cytomine.dummy.constrained.integer.addition | 0.1.0        | b              | 1               | integer        | {\"param_name\": \"b\", \"value\": 1}                   | {\"message\":\"value must be less than or equal to defined constraint\",\"details\":{\"type\":\"parameter\",\"param_name\":\"b\"},\"error_code\":\"APPE-internal-request-validation-error\"}       |
      | com.cytomine.dummy.constrained.integer.addition | 0.1.0        | c              | 0               | integer        | {\"param_name\": \"c\", \"value\": 0}                   | {\"message\":\"value must be greater than defined constraint\",\"details\":{\"type\":\"parameter\",\"param_name\":\"c\"},\"error_code\":\"APPE-internal-request-validation-error\"}                |
      | com.cytomine.dummy.constrained.integer.addition | 0.1.0        | d              | -1              | integer        | {\"param_name\": \"d\", \"value\": -1}                  | {\"message\":\"value must be greater than or equal to define constraint\",\"details\":{\"type\":\"parameter\",\"param_name\":\"d\"},\"error_code\":\"APPE-internal-request-validation-error\"}     |
      | com.cytomine.dummy.constrained.number.addition  | 0.1.0        | a              | 5.5             | number         | {\"param_name\": \"a\", \"value\": 5.5}                 | {\"message\":\"value must be less than defined constraint\",\"details\":{\"type\":\"parameter\",\"param_name\":\"a\"},\"error_code\":\"APPE-internal-request-validation-error\"}                   |
      | com.cytomine.dummy.constrained.number.addition  | 0.1.0        | a              | -15.5           | number         | {\"param_name\": \"a\", \"value\": -15.5}               | {\"message\":\"value must be greater than defined constraint\",\"details\":{\"type\":\"parameter\",\"param_name\":\"a\"},\"error_code\":\"APPE-internal-request-validation-error\"}                |
      | com.cytomine.dummy.constrained.number.addition  | 0.1.0        | b              | 14.21           | number         | {\"param_name\": \"b\", \"value\": 14.21}               | {\"message\":\"value must be less than or equal to defined constraint\",\"details\":{\"type\":\"parameter\",\"param_name\":\"b\"},\"error_code\":\"APPE-internal-request-validation-error\"}       |
      | com.cytomine.dummy.constrained.number.addition  | 0.1.0        | b              | -7.21           | number         | {\"param_name\": \"b\", \"value\": -7.21}               | {\"message\":\"value must be greater than or equal to define constraint\",\"details\":{\"type\":\"parameter\",\"param_name\":\"b\"},\"error_code\":\"APPE-internal-request-validation-error\"}     |
      | com.cytomine.dummy.constrained.number.addition  | 0.1.0        | c              | nan             | number         | {\"param_name\": \"c\", \"value\": nan}                 | {\"message\":\"value cannot be nan\",\"details\":{\"type\":\"parameter\",\"param_name\":\"c\"},\"error_code\":\"APPE-internal-request-validation-error\"}                                          |
      | com.cytomine.dummy.constrained.number.addition  | 0.1.0        | c              | inf             | number         | {\"param_name\": \"c\", \"value\": inf}                 | {\"message\":\"value cannot be infinity\",\"details\":{\"type\":\"parameter\",\"param_name\":\"c\"},\"error_code\":\"APPE-internal-request-validation-error\"}                                     |
      | com.cytomine.dummy.constrained.number.addition  | 0.1.0        | c              | -inf            | number         | {\"param_name\": \"c\", \"value\": -inf}                | {\"message\":\"value cannot be infinity\",\"details\":{\"type\":\"parameter\",\"param_name\":\"c\"},\"error_code\":\"APPE-internal-request-validation-error\"}                                     |
      | com.cytomine.dummy.constrained.string.identity  | 0.1.0        | input          | invalid str     | string         | {\"param_name\": \"input\", \"value\": \"invalid str\"} | {\"message\":\"value must be greater than or equal to define constraint\",\"details\":{\"type\":\"parameter\",\"param_name\":\"input\"},\"error_code\":\"APPE-internal-request-validation-error\"} |
      | com.cytomine.dummy.constrained.string.identity  | 0.1.0        | input          |                 | string         | {\"param_name\": \"input\", \"value\": \"\"}            | {\"message\":\"value must be greater than defined constraint\",\"details\":{\"type\":\"parameter\",\"param_name\":\"input\"},\"error_code\":\"APPE-internal-request-validation-error\"}            |
