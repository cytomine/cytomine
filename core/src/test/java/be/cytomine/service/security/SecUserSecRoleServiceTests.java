...
public class SecUserSecRoleServiceTests {
    ...
    void get_secSecUserSecRole_with_success() {
        ...
        assertThat(secSecUserSecRoleService.find(secSecUserSecRole.getSecUser(),
            secSecUserSecRole.getSecRole())).isPresent();
    }

    @Test
    void get_unexisting_secSecUserSecRole() {
        SecUserSecRole secSecUserSecRole =
            builder.given_a_not_persisted_user_role(builder.given_a_user(), "ROLE_ADMIN");
        assertThat(secSecUserSecRoleService.find(secSecUserSecRole.getSecUser(),
    ...
    void find_highest_role() {
        ...
        secSecUserSecRoleRepository.save(builder.given_a_not_persisted_user_role(user,
    ...
    void add_valid_secUser_SecRole_with_success() {
        SecUserSecRole secSecUserSecRole =
            builder.given_a_not_persisted_user_role(builder.given_a_user(),
                secRoleRepository.getAdmin());
    ...
    void user_cannot_add_user_role_to_a_guest() {
        SecUserSecRole secSecUserSecRole =
            builder.given_a_not_persisted_user_role(builder.given_a_guest(),
                secRoleRepository.getUser());
    ...
    void delete_secSecUserSecRole_with_success() {
        ...
        CommandResponse commandResponse = secSecUserSecRoleService.delete(secSecUserSecRole, null
            , null, true);
    ...
    void delete_secSecUserSecRole_with_simple_user_fail() {
        SecUserSecRole secSecUserSecRole =
            builder.given_a_not_persisted_user_role(builder.given_default_user(),
